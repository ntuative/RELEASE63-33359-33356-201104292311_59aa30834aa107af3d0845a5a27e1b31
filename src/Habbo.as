package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public function Habbo()
      {
         ...
         root.loaderInfo.addEventListener(IOErrorEvent.IO_ERROR,this.method_1);
      ...
      private function method_1(param1:IOErrorEvent) : void
      {
         trackLoginStep(const_9);
      ...
      private function finalizePreloading() : void
      {
         ...
         if(!this.var_6)
         {
            ...
            root.loaderInfo.removeEventListener(IOErrorEvent.IO_ERROR,this.method_1);
            nextFrame();
