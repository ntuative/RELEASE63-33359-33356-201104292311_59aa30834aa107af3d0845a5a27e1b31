package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1483:int = 20;
       
      
      private var var_129:HabboMessenger;
      
      private var var_2775:IScrollbarWindow;
      
      private var var_2030:IContainerButtonWindow;
      
      private var _list:IItemListWindow;
      
      private var var_551:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_129 = param1;
         this.var_2030 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this._list = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2775 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_129.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1055 + const_1483)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_129.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1482;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_551 == null || _loc1_.id != this.var_551.id)
         {
            this.var_551 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_551.followingAllowed)
         {
            this.var_2030.enable();
         }
         else
         {
            this.var_2030.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this._list.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_551.messages.length - const_1055);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_551.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_551.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_129.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_788 || param3.type == Message.const_973 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_551.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_129.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_129.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_129.send(new FollowFriendMessageComposer(this.var_551.id));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_129.conversations.closeConversation();
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_1189)
         {
            return 4294927974;
         }
         if(param1 == Message.const_950)
         {
            return 4293454056;
         }
         if(param1 == Message.const_793)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1166)
         {
            return 4288269465;
         }
         return 4291611852;
