package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_979:ConversationsTabView;
      
      private var var_970:ITextFieldWindow;
      
      private var var_15:IFrameWindow;
      
      private var var_1496:ConversationView;
      ...
      public function openMessenger() : void
      {
         ...
         if(this.var_15 == null)
         {
            this.prepareContent();
            this.refresh();
            this.var_129.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_57,HabboToolbarIconEnum.MESSENGER,this.var_15));
         }
         else
         {
            this.refresh();
      ...
      public function refresh() : void
      {
         ...
         this.var_979.refresh();
         this.var_1496.refresh();
         if(this.var_129.conversations.openConversations.length < 1)
         {
            this.var_15.visible = false;
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1496.addMessage(param2);
      }
      
      private function prepareContent() : void
      {
         this.var_15 = IFrameWindow(this.var_129.getXmlWindow("main_window"));
         ...
         this.var_979 = new ConversationsTabView(this.var_129,this.var_15);
         this.var_979.refresh();
         this.var_970 = ITextFieldWindow(this.var_15.findChildByName("message_input"));
         this.var_970.addEventListener(WindowKeyboardEvent.const_185,this.onMessageInput);
         this.var_1496 = new ConversationView(this.var_129,this.var_15);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_892,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1125,true);
         this.var_15.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc3_ = 120;
            _loc4_ = this.var_970.text;
            if(_loc4_.length > _loc3_)
            {
               this.var_970.text = _loc4_.substring(0,_loc3_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_970.text;
         ...
         this.var_970.text = "";
         this.var_129.conversations.addMessageAndUpdateView(new Message(Message.const_788,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_979 == null ? 7 : int(this.var_979.getTabCount());
      }
   }
}
