package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_459:uint = 3;
      
      private static const const_1441:uint = 1;
      ...
      private var var_1524:IEventDispatcher;
      
      private var var_1242:Boolean = false;
      
      private var var_1949:ProfilerOutput;
      
      private var var_1525:ProfilerAgentTask;
      
      private var var_1526:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_994 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_994);
         this.var_208 = new Array(const_459);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_459)
         {
            this.var_208[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_248 = this.var_208[const_1441];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1949)
            {
               this.var_1949 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1949.profiler = _loc3_;
            this.var_1525 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1525);
            this.var_1526 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1526);
            this.var_1242 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_208)
            {
               ...
               {
                  IDisposable(this.var_208.pop()).dispose();
               }
            }
            this.var_208 = null;
            if(this.var_266)
      ...
      {
         return this.var_248.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_248.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_266[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_266[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_994.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_208[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_208[param2].getDesktopWindow();
      ...
      {
         return this.var_208[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_208[param1].getDesktopWindow().getChildAt(this.var_248.getDesktopWindow().numChildren - 1);
      }
      
      public function getWindowContext(param1:uint) : IWindowContext
      {
         return this.var_208[param1];
      }
      
      public function getDesktop(param1:uint) : IDesktopWindow
      {
         var _loc2_:IWindowContext = this.var_208[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1524.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_459 - 1;
            while(_loc2_ >= 0)
            {
               this.var_208[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1242)
         ...
         this.var_1524.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_459)
         {
            this.var_208[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1242)
         {
         ...
         this.var_1524.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1544,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1780,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1719,param2.name + ": " + param2.toString());
            }
         }
      }
