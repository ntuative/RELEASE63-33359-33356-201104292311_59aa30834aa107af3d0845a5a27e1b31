package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      protected static const const_1832:String = "_alert_button_list";
      
      protected static const const_514:String = "_alert_button_ok";
      
      protected static const const_978:String = "_alert_button_cancel";
      
      protected static const const_1119:String = "_alert_button_custom";
      
      protected static const const_1313:String = "header_button_close";
      
      protected static const const_1696:String = "_alert_text_summary";
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         var _loc7_:IItemListWindow = this._window.findChildByName(const_1832) as IItemListWindow;
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_514);
               _loc8_.dispose();
            }
            if(!(param5 & 0))
            {
            ...
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_1119);
               _loc8_.dispose();
            }
         }
      ...
      public function getButtonCaption(param1:int) : ICaption
      {
         ...
         if(!this._disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_514:
                  _loc2_ = this._window.findChildByName(const_514) as IInteractiveWindow;
                  break;
               case HabboAlertDialogFlag.const_978:
                  _loc2_ = this._window.findChildByName(const_978) as IInteractiveWindow;
                  break;
               case HabboAlertDialogFlag.const_1119:
                  _loc2_ = this._window.findChildByName(const_1119) as IInteractiveWindow;
            }
         }
