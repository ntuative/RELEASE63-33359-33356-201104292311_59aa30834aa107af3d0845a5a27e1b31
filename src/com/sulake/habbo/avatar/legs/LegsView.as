   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.const_253,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.const_280,_windowManager,_assetLibrary);
         }
         else
         {
