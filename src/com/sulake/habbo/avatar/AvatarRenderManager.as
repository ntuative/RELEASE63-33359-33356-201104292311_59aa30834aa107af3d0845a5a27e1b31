package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2164:String = "hd-99999-99999";
      ...
      private var var_225:AvatarAssetDownloadManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_578 = RenderMode.const_1535;
         ...
         this.var_104.add(AvatarType.const_120,_loc4_);
         ...
         this.var_104.add(AvatarType.const_67,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_225)
         {
            this.var_225.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_304.init();
         this.var_801.init();
         _loc2_ = this.var_104.getValue(AvatarType.const_120) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_104.getValue(AvatarType.const_67) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_104.getValue(AvatarType.const_120) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_225 == null)
               {
                  ...
                  this.var_225 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_225.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_225.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_225.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_104.getValue(AvatarType.const_120) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_225.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1909)
         {
            this.var_1909 = new AvatarFigureContainer(this.const_2164);
         }
         this.var_225.loadFigureSetData(_loc6_,param4);
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_305 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_305.getKeys())
         {
            _loc4_ = this.var_305.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_304.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1796)
         {
            _loc6_ = !this.var_304.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_304.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_104.getValue(AvatarType.const_67) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_305.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_104.getValue(AvatarType.const_67);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_305.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_305.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_104.getValue(AvatarType.const_120) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_67:
               _loc3_ = this.var_104.getValue(AvatarType.const_67) as AvatarStructure;
               break;
            default:
