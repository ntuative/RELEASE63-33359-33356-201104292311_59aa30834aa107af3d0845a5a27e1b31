package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1871:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1518:IAvatarImage;
      ...
      private var var_368:IActiveActionData;
      
      private var var_445:AvatarImageBodyPartContainer;
      
      private var var_1485:String;
      
      private var var_116:AvatarImagePartContainer;
      
      private var var_2565:Point;
      ...
      private var var_2566:ByteArray;
      
      private var var_2564:ImageData;
      
      private var var_964:PaletteMap;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_256.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_256.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_256.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_256.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_256.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_256.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_790 == GeometryType.const_1106 && param1 == GeometryType.const_1282 || this.var_790 == GeometryType.const_1282 && param1 == GeometryType.const_1106)
         {
            this.var_790 = param1;
            this.var_85 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_256.add(param1,this._bodyPartCache);
         }
         var _loc3_:int = this._bodyPartCache.getDirection();
         var _loc4_:int = param2;
         this.var_368 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_368;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_368 || !this.var_368.definition))
         {
            if(this.var_368.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_368.definition.state + "." + this.var_368.actionParameter);
               _loc13_ = param2 - this.var_368.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_368.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_368 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_874)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_525)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1518.getFigure(),_loc5_,this.var_790,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_445 = _loc10_.getImageContainer(_loc4_);
         if(this.var_445 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_445 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_368);
            if(this.var_445 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_445,_loc4_);
         }
         this.var_445.offset = _loc8_;
         return this.var_445;
      }
      
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_256.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_256.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_85)
         {
            this.var_85 = this._structure.getCanvas(this._scale,this.var_790);
            if(!this.var_85)
            {
               return null;
            }
            this.var_2565 = new Point(0,this.var_85.height - int(this.var_85.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1614[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_975 || _loc10_ == AvatarAction.const_415;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1485 = this.var_116.bodyPartId;
               this.var_184 = this.var_116.partType;
               this.var_1884 = this.var_116.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_116.flippedPartType != this.var_184)
                     {
                        this.var_184 = this.var_116.flippedPartType;
                     }
                  }
               }
               this.var_1486 = this._scale + "_" + this.var_116.action.assetPartDefinition + "_" + this.var_184 + "_" + this.var_1884 + "_" + _loc5_ + "_" + this._frame;
               this.var_443 = this._assets.getAssetByName(this.var_1486) as BitmapDataAsset;
               if(this.var_443 == null)
               {
                  this.var_1486 = this._scale + "_std_" + this.var_184 + "_" + this.var_1884 + "_" + _loc5_ + "_0";
                  this.var_443 = this._assets.getAssetByName(this.var_1486) as BitmapDataAsset;
               }
               if(!(!this.var_443 || !this.var_443.content))
               {
                  ...
                  {
                     this.var_964 = this._structure.renderManager.paletteManager.getPalette(this.var_116.paletteMapId);
                     if(this.var_964 != null)
                     {
                        this.var_973 = this.var_443.content as BitmapData;
                        this.var_183 = new BitmapData(this.var_973.width,this.var_973.height);
                        this.var_2566 = this.var_964.colorize(this.var_973.getPixels(this.var_973.rect));
                        this.var_183.setPixels(this.var_183.rect,this.var_2566);
                     }
                     else
                     {
                        this.var_183 = (this.var_443.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1485 == AvatarBodyPartType.const_289 || this.var_1485 == AvatarBodyPartType.const_1620 || this.var_1485 == AvatarBodyPartType.const_1638) && this.var_116.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  this.var_971 = this.var_443.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_53)
                     {
                  ...
                  this.var_2564 = new ImageData(this.var_183,this.var_971,_loc7_);
                  this.var_972.push(this.var_2564);
               }
            }
            _loc8_--;
         }
         ...
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2565.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_53)
            {
