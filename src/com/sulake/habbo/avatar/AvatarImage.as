package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1409:String = "Default";
      
      private static const const_1410:int = 2;
      
      private static const const_1408:String = AvatarSetType.const_34;
      ...
      protected var var_765:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_256:AvatarImageCache;
      
      protected var var_666:AvatarFigureContainer;
      
      protected var var_574:IAvatarDataContainer;
      
      protected var var_329:Array;
      
      protected var var_46:BitmapData;
      
      private var var_995:IActiveActionData;
      ...
      private var var_2536:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_666 = param3;
         this.var_256 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1408,const_1410);
         this.var_329 = new Array();
         this.var_995 = new ActiveActionData(AvatarAction.const_389);
         this.var_995.definition = this._structure.getActionDefinition(const_1409);
         this.resetActions();
      ...
      {
         param2 += this.var_1861;
         if(param2 < AvatarDirectionAngle.const_1257)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_255.length == 1 && this.var_87 == this.var_1687)
         {
            return this.var_87 + this.var_519 + this.var_626 % 4;
         }
         if(this.var_255.length == 2)
         {
      ...
      {
         if(param3 != this.var_2537 || param2 != this.var_2536 || param1 != this.var_2535)
         {
            this.var_2537 = param3;
            this.var_2536 = param2;
            this.var_2535 = param1;
            this.var_1862 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_285.definition.geometryType,this.var_87);
         this.var_46.lock();
         ...
         {
            if(this.var_574.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc13_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_574.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_285.definition.geometryType,this.var_87);
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_285 = this.var_995;
         this.var_285.definition = this.var_995.definition;
         this.resetBodyPartCache(this.var_995);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_519 = "";
         this.var_255 = this._structure.sortActions(this.var_329);
         if(this.var_255 == null)
         {
         ...
         {
            this.var_765 = this._structure.getCanvasOffsets(this.var_255,this._scale,this.var_87);
            for each(_loc4_ in this.var_255)
            {
               this.var_519 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_357)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1465 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1465 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1464 != this.var_519)
            {
               _loc1_ = true;
               this.var_1464 = this.var_519;
            }
         }
         this.var_1463 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_255)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_996 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1861 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_574 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_319 || _loc1_.actionType == AvatarAction.const_277 || _loc1_.actionType == AvatarAction.const_415)
               {
                  this.var_996 = true;
               }
            }
