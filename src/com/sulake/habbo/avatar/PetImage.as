package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_256:AvatarImageCache;
      ...
      private var var_574:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_50)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1532);
            if(_loc3_ != null)
            {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_519 = this.var_519 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_416:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1605:
                  case AvatarAction.const_1739:
                  case AvatarAction.const_1623:
                  case AvatarAction.const_1122:
                  case AvatarAction.const_1118:
                  case AvatarAction.const_1670:
                  case AvatarAction.const_1763:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_995);
         this.getCache().resetBodyPartCache(this.var_995);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1531 = this._structure.sortActions(this.var_329);
         ...
         {
            this.var_765 = this._structure.getCanvasOffsets(this.var_1531,this._scale,this.var_87);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1531)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_415)
               {
                  this.var_996 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_277)
               {
                  this.var_996 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_319)
               {
                  this.var_996 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1306 = _loc4_.id;
                     this.var_1849 = _loc4_.breed;
                     break;
                  }
               }
            }
