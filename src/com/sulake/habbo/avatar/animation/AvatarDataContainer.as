package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1845:Number = 1.0;
      
      private var var_1846:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1279:Map;
      
      private var var_2770:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_2018 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2771 = parseInt(_loc2_,16);
         this.var_2772 = parseInt(_loc3_,16);
         ...
         this.var_805 = new ColorTransform(this.var_1843,this.var_1845,this.var_1846,this._alphaMultiplier);
         this.var_1279 = this.generatePaletteMapForGrayscale(this.var_2772,this.var_2771);
      }
      ...
      {
         return this.var_1279.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1279.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1279.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1279.getValue("alphas") as Array;
      }
