package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1351:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1352:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1150:AvatarEditorHandler;
      ...
      private var var_599:Dictionary;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_195)
         {
            ...
            this.var_599["null"] = new FigureData(this);
            this.var_599["null"] = new FigureData(this);
            _loc2_ = this.var_599["null"];
            _loc3_ = this.var_599["null"];
            _loc2_.loadAvatarData(const_1351,FigureData.const_82);
            _loc3_.loadAvatarData(const_1352,FigureData.FEMALE);
            this.var_101 = new Map();
            this.var_496 = new Map();
            this.var_101.add(AvatarEditorFigureCategory.const_730,new BodyModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_289,new TorsoModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_956,new LegsModel(this));
            ...
            this.var_496.add(AvatarEditorSideCategory.const_111,new WardrobeModel(this));
            this.var_496.add(AvatarEditorSideCategory.const_495,new ClubPromoModel(this));
            this.var_195 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_599[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_248 == null)
            {
               this.var_248 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_74,HabboWindowStyle.const_29,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_248.addChild(this._view.window);
               if(param5)
               {
                  this.var_248.center();
               }
            ...
            this.var_248.visible = !this.var_248.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_730);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_496.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_497 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_920 = this.var_497.getFigureData(AvatarType.const_120);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1150 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_599[this.var_1017];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1407 != null)
         {
            ...
            this.var_1407.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1732;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1151 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1353)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1615.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_497.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_497.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1330.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1624)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1151 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1330.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1151 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_496.getValue(AvatarEditorSideCategory.const_111);
      }
