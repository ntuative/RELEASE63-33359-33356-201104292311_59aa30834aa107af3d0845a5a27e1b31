package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1330:IWindowContainer;
      ...
      private var var_357:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_507:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1166 = [];
         this.var_1429 = [AvatarEditorFigureCategory.const_730,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_289,AvatarEditorFigureCategory.const_956,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_111];
         super();
         ...
         if(var_1330 == null)
         {
            ...
            var_1330 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1615 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1615 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_428 = new Timer(1000);
         this.var_428.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_428.stop();
            this.var_428.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_428 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1.length != this.var_1166.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1166.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2409 = this.canChangeOutfit();
            this.var_428.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_357 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_357.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_357.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1166.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_357.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_357.numSelectables)
               {
                  this.var_357.getSelectableAt(_loc6_).x = this.var_357.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_357.setSelected(this.var_357.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_44) && (this.var_1775 == AvatarEditorSideCategory.const_111 || this.var_2408))
         {
      ...
      {
         if(this.var_1775 == AvatarEditorSideCategory.const_111)
         {
            this.var_2408 = false;
            this.setSideContent(AvatarEditorSideCategory.const_821);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_821:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_367 = param1;
         this.var_357.setSelected(this.var_357.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2217 = new Date().valueOf();
                  this.var_2409 = false;
                  this.var_428.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_507)
         {
            ...
            this.var_507 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_507.procedure = this.stripClubDialogEventProc;
            this.var_507.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2217 > 5000;
      }
   }
}
