package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_327:int = 3;
      
      private static var var_1548:int = 2;
      ...
      private var var_1988:TriggerConfs;
      
      private var var_1987:ActionTypes;
      
      private var var_1989:ConditionTypes;
      
      private var var_275:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_826:RoomObjectHightLighter;
      ...
      {
         this.var_1988 = new TriggerConfs();
         this.var_1987 = new ActionTypes();
         this.var_1989 = new ConditionTypes();
         this.var_275 = new Dictionary();
         super();
         this.var_80 = param1;
         this.var_826 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_275[param1])
         {
            delete this.var_275[param1];
            this.var_826.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_36.furniLimit)
         {
            this.var_275[param1] = param2;
            this.var_826.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1258 = new SliderWindowController(this.var_80,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_80.assets,0,20,1);
         this.var_1258.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1258.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_826.hideAll(this.var_275);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_36.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_327)
            {
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_80.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_36.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_36 as TriggerDefinition != null)
         {
            this.var_80.send(new UpdateTriggerMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ActionDefinition != null)
         {
            this.var_80.send(new UpdateActionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ConditionDefinition != null)
         {
            this.var_80.send(new UpdateConditionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1258.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1548) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1548 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_80.send(new ApplySnapshotMessageComposer(this.var_36.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_327)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1988);
         this.refreshConfigureElement(this.var_1987);
         this.refreshConfigureElement(this.var_1989);
