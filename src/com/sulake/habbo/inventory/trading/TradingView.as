package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1043:uint = 4284532064;
      
      private static const const_1044:uint = 2577770;
      ...
      private var var_660:ItemPopupCtrl;
      ...
      private var var_1000:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_660 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1958 = this.createMinimizedWindow();
         }
         if(!this.var_2682)
         {
            return this.var_69;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_69)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_1043) : uint(const_1044);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_1043) : uint(const_1044);
            }
         ...
         if(this.var_69)
         {
            ...
            switch(this.var_18.state)
            {
               ...
               case TradingModel.const_335:
                  ...
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_550:
                  _loc1_.disable();
                  this.showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_279:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
      ...
      public function removeSelection() : void
      {
         if(this.var_1000)
         {
            this.var_1000.isSelected = false;
            this.var_1000 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1730)
            {
            ...
            this.var_660.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_593);
            this.var_660.show();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT)
         {
            this.var_660.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_189.push(param4);
            this.var_189.push(param1);
            this.var_189.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_189.length > 0)
         {
            _loc2_ = this.var_189.pop();
            _loc3_ = this.var_189.pop();
            _loc4_ = uint(this.var_189.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_660.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_593);
               }
            }
            else
            {
               this.var_189.push(_loc4_);
               this.var_189.push(_loc3_);
