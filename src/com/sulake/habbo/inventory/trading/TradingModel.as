package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1821:uint = 9;
      
      public static const const_226:uint = 0;
      
      public static const const_201:uint = 1;
      ...
      public static const const_279:uint = 5;
      ...
      private var var_744:Boolean = false;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_54.updateItemList(this.var_745);
         this.var_54.updateItemList(this.var_1403);
      ...
      public function close() : void
      {
         if(this.var_862)
         {
            if(this._state != const_226 && this._state != const_279)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_744 + " OTHER: " + this.var_1146);
         ...
         {
            case const_226:
               if(param1 == const_201 || param1 == const_279)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_247 == null || this.var_247.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_247.length)
         {
            _loc2_ = this.var_247.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         else if(param1 is TradingAcceptEvent)
         {
            ...
            if(TradingAcceptEvent(param1).userID == this.var_745)
            {
               this.var_744 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1146 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_54.updateUserInterface();
         }
         else if(param1 is TradingConfirmationEvent)
         {
            ...
            this.state = const_444;
         }
         else if(param1 is TradingCompletedEvent)
         {
            Logger.log("TRADING::TradingCompletedEvent");
            this.state = const_279;
         }
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_745)
            {
               this.var_54.alertPopup(TradingView.const_1231);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_247.length < const_1821)
         {
         ...
         else
         {
            ...
            if(this.var_247.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
