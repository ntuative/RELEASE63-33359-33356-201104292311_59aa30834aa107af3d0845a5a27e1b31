package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const include:String = "pets";
      ...
      private var var_2047:Vector.<Array>;
      
      private var var_2046:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_680 = new Timer(const_1502,1);
         this.var_680.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2817 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_680.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_680.stop();
               this.var_680 = null;
            }
            if(this.var_213 != null)
            {
               this.var_213.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_213.stop();
               this.var_213 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_46)
            {
               ...
               {
                  this.var_2047 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2047;
            }
            else
            {
               if(this.var_2046 == null)
               {
                  this.var_2046 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2046;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_363)
         {
         ...
         if(this.var_1045 == null)
         {
            this.var_1045 = this._windowManager.buildFromXML(this.var_2817) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_1045.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_46,const_48];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_213 = new Timer(param1,1);
            this.var_213.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_213.start();
         }
         else
         {
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_408);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_46,const_48];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_46,const_48];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_681.add(const_46,new Array());
         this.var_681.add(const_48,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         else
         {
            ...
            for(; _loc9_ < _loc7_.length; _loc9_++)
            {
               ...
               if(_loc8_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_216)
                  {
                     _loc6_ = _loc8_;
                  }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_326;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_329 || _loc3_.category == FurniCategory.const_306 || _loc3_.category == FurniCategory.const_363)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_681.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_857)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
