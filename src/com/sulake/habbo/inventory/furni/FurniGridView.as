package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_279 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            this.var_279.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_279.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_279.autoArrangeItems = false;
            this.var_279.lock();
         }
         else
         {
            this.var_279.autoArrangeItems = true;
            this.var_279.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_41)
         {
            ...
            this.var_67.toggleItemSelection(this._category,this.var_279.getGridItemIndex(param1.window));
            this.var_628 = param2;
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT && this.var_628 != null && this.var_628 == param2 && !this.var_67.isTradingOpen)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_139)
         {
