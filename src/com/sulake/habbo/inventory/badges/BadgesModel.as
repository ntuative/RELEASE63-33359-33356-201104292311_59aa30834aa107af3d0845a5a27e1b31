package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_421 = param5;
         this.var_421.events.addEventListener(BadgeImageReadyEvent.const_151,this.onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_1034.length)
         {
            if(this.var_1034[_loc2_] == param1)
            {
               this.var_1034.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_421.getBadgeImage(param1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = this.var_277[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < this.var_277.length)
               {
                  if((this.var_277[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(this.var_277[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_317 && this._controller.isVisible)
         {
