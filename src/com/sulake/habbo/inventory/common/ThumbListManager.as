package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1385:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_591 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_591.width;
         this.var_90 = this.var_591.height;
         this.var_1129 = param5;
         this.var_906 = param6;
         this.var_218 = Math.floor(this.var_1129 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1129,this.var_906);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_590 = this.resolveRowCountFromList();
         if(this.var_590 == 0)
         {
            this.var_26 = new BitmapData(this.var_1129,this.var_906);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_218 * this._thumbWidth,this.var_1129),Math.max(this.var_590 * this.var_90,this.var_906),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_590)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_218)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_218 && this.var_26.height < _loc3_.y * this.var_90)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_218 - 1),this.var_90);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_218 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_90),null,null,true);
         _loc4_ = new Rectangle(0,this.var_90,this._thumbWidth * (this.var_218 - 1),this.var_26.height - this.var_90);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1385.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_218));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_218 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_218);
         var _loc3_:int = param1 % this.var_218;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_218)
         {
            return;
         }
         if(param1.y >= this.var_590)
         {
            return;
         }
         var _loc4_:int = this.var_218 - param1.x - 1;
         ...
         if(this.var_26.height < this.var_906)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_906);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_591.width,this.var_591.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_591.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_591,this.var_591.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
