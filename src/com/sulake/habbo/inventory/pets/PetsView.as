package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_279:IItemGridWindow;
      ...
      private var var_393:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_279 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_393);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_683.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_279.removeGridItem(_loc2_.window);
      ...
      {
         if(this.var_683 == null || this.var_683.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_683.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_683.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_279.addGridItem(_loc2_.window);
            this.var_683.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_393.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_58)
         {
            ...
            {
               case "tab_floor":
                  this.var_67.switchCategory(FurniModel.const_46);
                  break;
               case "tab_wall":
                  this.var_67.switchCategory(FurniModel.const_48);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_393 != null)
         {
            this.var_393.setSelected(false);
         }
         this.var_393 = param1;
         if(this.var_393 != null)
         {
            this.var_393.setSelected(true);
         }
