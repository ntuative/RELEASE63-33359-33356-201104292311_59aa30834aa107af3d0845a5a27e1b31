package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_800,RoomWidgetEcotronBoxOpenMessage.const_875,RoomWidgetEcotronBoxOpenedMessage.const_1812];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_800:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_875:
