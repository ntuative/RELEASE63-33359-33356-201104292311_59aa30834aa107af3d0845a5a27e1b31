package com.sulake.habbo.ui
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_810 = [];
         this.var_810.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_810.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_810)
         {
            return;
         }
         for each(_loc1_ in this.var_810)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_887);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_700);
         return _loc1_;
      }
