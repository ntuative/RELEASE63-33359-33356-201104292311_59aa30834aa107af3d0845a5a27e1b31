package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this._inventory && !this._inventory.disposed && this._inventory.events)
            {
               ...
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_939,this.onHabboClubSubscriptionChanged);
            }
         ...
         if(this._inventory != null)
         {
            ...
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_939,this.onHabboClubSubscriptionChanged);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1437)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc5_.setDirection(AvatarSetType.const_34,2);
                  _loc1_ = _loc5_.getCroppedImage(AvatarSetType.const_34);
                  _loc2_ = _loc5_.getCroppedImage(AvatarSetType.const_50);
                  _loc5_.dispose();
               }
               this.var_1437 = _loc3_;
               this.var_1796 = _loc1_;
               this.var_1797 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1796;
               _loc2_ = this.var_1797;
            }
         }
         if(this._toolbar != null)
         {
            _loc6_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1127,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_452)
               {
                  ...
                  if(_loc2_.height > const_452 - const_1005)
                  {
                     _loc8_.offset(0,_loc2_.height - const_452 + const_1005);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_961);
         _loc1_.push(RoomWidgetDanceMessage.const_925);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_706);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_974);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_794);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_865);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_742);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_425);
         _loc1_.push(RoomWidgetStopEffectMessage.const_907);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1776);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1094);
         _loc1_.push(RoomWidgetToolbarMessage.const_727);
         _loc1_.push(RoomWidgetToolbarMessage.const_796);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_418);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1752);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1184);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_972);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_877);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_945);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1548);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_699);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_937);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_854);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_442);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_877:
               ...
               break;
            case RoomWidgetWaveMessage.const_961:
            ...
            case RoomWidgetDanceMessage.const_925:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_706:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_974:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_794:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_425:
               ...
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_209,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_742:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1210:
                        this._catalog.openCatalogPage(CatalogPageName.const_1540,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1105:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_317);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1802:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_81);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1534:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_865:
            case RoomWidgetStopEffectMessage.const_907:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1094:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_972:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_727:
               ...
               break;
            case RoomWidgetToolbarMessage.const_796:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_473,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_418:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_486));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_945:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_371,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_699:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_371,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_937:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_371,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_854:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_563));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_442:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_728));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_976));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_586:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_519));
         }
      }
