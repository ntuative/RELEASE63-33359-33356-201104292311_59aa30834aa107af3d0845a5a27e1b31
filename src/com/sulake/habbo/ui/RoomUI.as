package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1153:IRoomWidgetFactory;
      ...
      {
         this.var_1412 = RoomDesktop.const_507;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1153.release(new IIDHabboRoomWidget());
            this.var_1153 = null;
         }
         ...
         {
            this.var_497.release(new IIDAvatarRenderManager());
            this.var_497 = null;
         }
         ...
         {
            this.var_922.release(new IIDHabboModeration());
            this.var_922 = null;
         }
         ...
         if(this.var_295)
         {
            ...
            {
               _loc1_ = this.var_295.getKey(0) as String;
               _loc2_ = this.var_295.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1153 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_497 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1739 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_296.events.addEventListener(AdEvent.const_595,this.adEventHandler);
            this.var_296.events.addEventListener(AdEvent.const_622,this.adEventHandler);
            this.var_296.events.addEventListener(AdEvent.const_644,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_922 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_922);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_16)
         {
            ...
            this.var_16.events.addEventListener(RoomSessionEvent.const_94,this.roomSessionStateEventHandler);
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_215,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_615,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_157,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_62,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPresentEvent.const_310,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_585,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_613,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_574,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_480,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1246,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1299,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_244,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_242,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_824,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_203,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_911,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_687,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionQueueEvent.const_502,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionVoteEvent.const_142,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionVoteEvent.const_158,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_138,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_73,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_153,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDimmerPresetsEvent.const_485,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionFriendRequestEvent.const_156,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserNotificationEvent.const_129,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserDataUpdateEvent.const_133,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_89:
               this._toolbar.events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_305));
               break;
            case RoomSessionEvent.const_94:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_183,HabboToolbarIconEnum.ZOOM));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_183,HabboToolbarIconEnum.MEMENU));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_183,HabboToolbarIconEnum.INVENTORY));
                  this._toolbar.events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_340));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_824:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_911:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_876,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_620,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_64,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_811,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.ROOM_OBJECT_SELECTED,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_575,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_390,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_766,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_610,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_499,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_238,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_876)
         {
            if(this.var_16 != null)
            {
               this.var_16.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_620 || param1.type == RoomEngineEvent.const_606)
         {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_304:
               ...
               if(this._roomEngine != null)
               {
                  ...
                  if(!this._roomEngine.isPublicRoomWorldType(this._roomEngine.method_5(param1.roomId,param1.roomCategory)))
                  {
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_789);
               ...
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_410);
               }
               if(!_loc5_)
               {
               ...
               if(this.var_1412 != RoomDesktop.const_507)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_338,this.var_1412);
               }
               if(this.var_296 != null)
               {
            ...
            case RoomEngineEvent.const_300:
               ...
               break;
            case RoomEngineRoomColorEvent.const_811:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.init();
         this.var_295.add(_loc2_,_loc3_);
         return _loc3_;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_295.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_338);
            if(_loc3_ != RoomDesktop.const_507)
            {
               this.var_1412 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
      ...
      {
         return this.var_295.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_295.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
