package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_812:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_447.length)
            {
               _loc2_ = this.var_447.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_308 != null)
         {
            ...
            {
               _loc2_ = this.var_308.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1231)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_520,RoomWidgetChatSelectAvatarMessage.const_881];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_520:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1108))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1108))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_881:
      ...
      {
         return [RoomSessionChatEvent.const_215];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_215:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_225)
                           {
                              _loc13_ = this.var_308.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_447.getValue(_loc16_) as BitmapData;
                           }
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_225:
                                       _loc13_ = this.getPetImage(_loc16_);
                                       _loc12_ = uint(this.var_649.getValue(_loc16_));
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_95,null,this);
                                       if(_loc17_ != null)
                                       {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_225)
                                    {
                                       this.var_308.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_447.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1232 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1232);
            }
            if(this.var_812 == null)
            {
               ...
               this.var_533.y = 0;
               this.var_533.z = 0;
               this.var_812 = _loc4_.getScreenPoint(this.var_533);
               this.var_1232 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_533.x = 0;
            this.var_533.y = 0;
            this.var_533.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_533);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_812.x || _loc8_.y != this.var_812.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_812,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_308)
         {
            _loc2_ = this.var_308.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_447)
         {
            _loc2_ = this.var_447.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1231.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_95,this);
            if(_loc5_ != null)
            {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1930.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1930.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_308)
            {
               this.var_308.add(_loc3_,param2);
            }
         }
      }
   }
