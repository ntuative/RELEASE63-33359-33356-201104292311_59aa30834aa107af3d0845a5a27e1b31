package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1470:String = "room_view";
      
      private const const_2168:String = "room_widget";
      
      private var var_49:IWindowContainer;
      
      private var var_830:int = 50;
      
      private var var_2965:XML = null;
      ...
      public function addWidgetWindow(param1:String, param2:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(this.const_2168) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_49.getChildByTag(this.const_1470) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         {
            case "LEFT":
               _loc2_.x = this.var_830;
               _loc2_.width = this.var_49.desktop.width - this.var_830;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = this.var_830;
               _loc2_.height = this.var_49.desktop.height - this.var_830;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_49.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_49.findChildByTag(this.const_1470) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
