package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1519:int = -1.0E9;
      
      private var var_816:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_816 = new Object();
         super();
         this.var_12 = param1;
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            param1.addMessageEvent(new ChatMessageEvent(this.method_7));
            param1.addMessageEvent(new WhisperMessageEvent(this.method_7));
            param1.addMessageEvent(new ShoutMessageEvent(this.method_7));
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         var _loc18_:XML = this._planeParser.method_6();
         ...
         if(this.var_816.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_816.objectData);
            this.var_816.objectData = null;
         }
         else
         {
            this.var_816.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_816.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_816.objectData = _loc6_;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_688);
         var _loc8_:int = 0;
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_1156:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1145:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1220,_loc3_.status);
         }
      }
