package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_1890:int = 0;
      ...
      private static const const_673:String = "wall_place_holder";
      
      private static const const_675:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_461;
      
      private static const const_674:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1049:String = "selection_arrow";
      ...
      private var var_1028:Map = null;
      
      private var var_454:Dictionary;
      
      private var var_1027:Map = null;
      
      private var var_212:PublicRoomData = null;
      
      private var var_1565:Map = null;
      
      private var var_669:Map = null;
      
      private var var_546:Map = null;
      
      private var var_548:Map = null;
      
      private var var_834:Map = null;
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_454 = new Dictionary();
         this.var_2741 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2738 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2740 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2739 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function initPetData() : void
      {
         ...
         {
            this.var_454[_loc3_] = _loc2_;
            this.var_1028.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_421.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_455.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_455.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_454)
            {
               delete this.var_454[_loc1_];
            }
            this.var_454 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_834.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_456.add(_loc3_,_loc4_);
               if(this.var_384[_loc7_] == null)
               {
                  this.var_384[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_670.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_669.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_669.remove(_loc7_);
               this.var_669.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2742)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_769));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_548 != null)
         {
            this.var_548.remove(param2);
            this.var_548.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_548 != null)
         {
            _loc2_ = this.var_548.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_212 != null && (this.var_212.type == param1 || this.var_212.hasWorldType(param1)))
         {
      ...
      {
         return [const_461,const_673,const_675,const_674,TILE_CURSOR,const_1049];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_456.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_670.getValue(param1) as String;
      ...
      {
         return this.var_1028.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1027[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_670.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_834.getValue(param1) != null)
         {
            return this.var_834.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_212 != null && this.var_212.hasWorldType(const_368 + param1))
         {
            return this.var_212.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_292 || param1 == RoomObjectVisualizationEnum.const_67 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_26 || _loc2_ == RoomObjectCategoryEnum.const_25)
         {
            ...
            return int(this.var_669.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2739 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         switch(param2)
         {
            case RoomObjectCategoryEnum.const_26:
               this.var_456[param1] = _loc4_;
               break;
            case RoomObjectCategoryEnum.const_25:
               this.var_670[param1] = _loc4_;
               break;
            default:
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_26:
                     if(this.var_384[_loc4_] == null)
                     {
                        this.var_384[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_25:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_382,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1565.getValue(param1) != null)
         {
            this.var_212 = this.var_1565.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_935,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2741.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1658);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_454[_loc5_] != null)
            {
               this.extractPetDataFromLoadedContent(_loc5_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_382,_loc5_);
         }
         else
         {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_454[param1];
            this.var_1027.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1565.add(param1,_loc4_);
         this.var_212 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_835.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_835.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_835.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return this.method_6(param1,"_visualization");
      }
      
      public function getAssetXML(param1:String) : XML
      {
         return this.method_6(param1,"_assets");
      }
      
      public function getLogicXML(param1:String) : XML
      {
         return this.method_6(param1,"_logic");
      }
      
      private function method_6(param1:String, param2:String) : XML
      {
         var _loc3_:IAssetLibrary = this.getAssetLibrary(param1);
         if(_loc3_ == null)
         {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_514.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_455.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_455[_loc2_] != null)
         {
            _loc3_ = this.var_455.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_368 + param1) == RoomObjectCategoryEnum.const_83)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_212.getWorldHeightScale(const_368 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_212 != null)
         {
            return this.var_212.getWorldScale(const_368 + param1);
         }
         return 32;
      }
      ...
      {
         this.var_456.remove(param1);
         this.var_456.add(param1,param2);
      }
   }
}
