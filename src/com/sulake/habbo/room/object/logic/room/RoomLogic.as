package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_2035:int = 255;
      
      private var var_1599:uint = 16777215;
      
      private var var_2073:int = 255;
      
      private var var_1311:uint = 16777215;
      
      private var var_2071:int = 255;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_579,RoomObjectMouseEvent.const_147];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_785,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_904,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_807,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_910,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1310)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_2035;
            if(_loc2_ - this.var_1310 >= this.var_2072)
            {
               _loc3_ = this.var_1311;
               _loc4_ = this.var_2071;
               this.var_1310 = 0;
            }
            else
            {
               _loc7_ = this.var_1599 >> 16 & 255;
               _loc8_ = this.var_1599 >> 8 & 255;
               _loc9_ = this.var_1599 & 255;
               _loc10_ = this.var_1311 >> 16 & 255;
               _loc11_ = this.var_1311 >> 8 & 255;
               _loc12_ = this.var_1311 & 255;
               _loc13_ = (_loc2_ - this.var_1310) / this.var_2072;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2073 + (this.var_2071 - this.var_2073) * _loc13_;
               this._color = _loc3_;
               this.var_2035 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_785,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_960:
            ...
            case RoomObjectRoomUpdateMessage.const_795:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_760:
               param2.setString(RoomObjectVariableEnum.const_208,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_474:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_276)
               {
                  _loc5_ = "null";
               }
               this.var_492.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_914:
               _loc4_ = this.var_492.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_492.method_6();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1155,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1264:
               param2.setNumber(RoomObjectVariableEnum.const_904,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1276:
               param2.setNumber(RoomObjectVariableEnum.const_807,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_910,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1114,int(param1.bgOnly));
         this.var_1599 = this._color;
         this.var_2073 = this.var_2035;
         this.var_1311 = _loc3_;
         this.var_2071 = _loc4_;
         this.var_1310 = getTimer();
         this.var_2072 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_517,0);
            }
            return;
         }
         _loc5_--;
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc13_ && _loc7_.y >= 0 && _loc7_.y < _loc14_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1822,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1564,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_517,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_186 || _loc12_ == RoomPlaneData.const_346)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
