package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1320:Number = 0.0;
      
      private var var_144:Number = 0.0;
      
      private var var_983:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         this.var_260 = param1;
         this._height = param2;
         this.var_563 = this.var_260;
         this.var_565 = -1;
         this.var_564 = this._height;
         this.var_566 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_260 && param2 >= 0 && param2 < this._height)
         {
            _loc4_ = this.var_172[param2] as Array;
            _loc4_[param1] = param3;
            if(param3 >= 0)
            {
               if(param1 < this.var_563)
               {
                  this.var_563 = param1;
               }
               ...
               if(param2 < this.var_564)
               {
                  this.var_564 = param2;
               }
               if(param2 > this.var_566)
               {
                  this.var_566 = param2;
               }
            }
            ...
            {
               if(param1 == this.var_563 || param1 == this.var_565)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_564;
                  while(_loc6_ < this.var_566)
                  {
               ...
               if(param2 == this.var_564 || param2 == this.var_566)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_563;
                  while(_loc8_ < this.var_565)
                  {
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_172[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(this.var_172);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         this.var_983 = getFloorHeight(this.var_172);
         if(!param1)
         {
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < this.var_172.length)
         {
            _loc4_ = this.var_172[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      {
         var _loc11_:* = null;
         this.addPlane(RoomPlaneData.const_186,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_346,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_1320);
         this.addPlane(RoomPlaneData.const_186,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_186,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_144) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_186,Vector3d.sum(param1,Vector3d.product(param3,-this.var_144 / param3.length)),Vector3d.product(param3,(param3.length + this.var_144) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1320 / param2.length);
               this.addPlane(RoomPlaneData.const_186,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_172 == null || param1 == this.var_172)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > this.var_172.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_172[_loc3_] as Array;
      ...
      {
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_195,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_195,_loc13_,new Vector3d(0,0,-this.var_144),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_144,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,this.var_144,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_195,_loc13_,new Vector3d(0,0,-this.var_144),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_144,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,this.var_144,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_195,_loc13_,new Vector3d(0,0,-this.var_144),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_144,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,this.var_144,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_195,_loc13_,new Vector3d(0,0,-this.var_144),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_144,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,this.var_144,param11);
                  }
               }
            }
         }
      ...
      public function addPlane(param1:int, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Array = null) : RoomPlaneData
      {
         ...
         this.var_145.push(_loc6_);
         return _loc6_;
      }
      
      public function method_6() : XML
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null;
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_145[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1237;
         }
         var _loc2_:RoomPlaneData = this.var_145[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_145[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
