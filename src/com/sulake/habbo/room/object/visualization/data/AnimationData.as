package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_2061:int = 0;
      ...
      private var var_1445:Array = null;
      ...
      public function method_14(param1:Array) : void
      {
      ...
      {
         if(this.var_1445 != null && this.var_1445.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function getStartFrame(param1:int) : int
      {
         ...
         return Math.random() * this.var_458;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         if(_loc10_ > this.var_458)
         {
            this.var_458 = _loc10_;
         }
         return true;
      }
