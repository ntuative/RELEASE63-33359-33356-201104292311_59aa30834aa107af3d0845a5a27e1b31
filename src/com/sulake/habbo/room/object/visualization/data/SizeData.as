package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_391:int = 1000;
      ...
      private var var_1533:int = 360;
      
      private var var_819:DirectionData = null;
      
      private var var_268:Map;
      
      private var _colors:Map;
      
      private var var_1247:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_819 = new DirectionData(param1);
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_819,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc3_.copyValues(this.var_819);
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1095);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1182);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1533 / 2) % 360 / this.var_1533;
         ...
         {
            _loc6_ = int(this.var_268.getKey(_loc5_)) * this.var_1533;
