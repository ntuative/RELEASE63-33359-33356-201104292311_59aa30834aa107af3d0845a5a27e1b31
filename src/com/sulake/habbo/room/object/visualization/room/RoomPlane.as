package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_887:IPlaneRasterizer = null;
      
      private var var_714:PlaneMaskManager = null;
      ...
      private var var_407:PlaneBitmapData = null;
      ...
      private var var_713:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_1357 = [];
         super();
         this.var_2171 = param8;
         this.var_1098 = new Vector3d();
         this.var_1098.assign(param1);
         this.var_89 = new Vector3d();
         this.var_89.assign(param2);
         this.var_290 = new Vector3d();
         this.var_290.assign(param3);
         this.var_291 = new Vector3d();
         this.var_291.assign(param4);
         ...
         this.var_2170 = param10;
         this.var_2174 = param11;
         this.var_2173 = param12;
         this.var_888 = param6;
      }
      ...
      {
         return this._isVisible && this.var_713;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_887.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_407;
         if(_loc3_ == null)
         {
         ...
         if(this.var_713 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_337))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_290.length * param1.scale;
            _loc6_ = this.var_291.length * param1.scale;
            ...
            if(this.var_887 != null)
            {
               _loc3_ = this.var_887.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1635,this.var_2172,this.var_2170,this.var_2174,this.var_2173,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1682 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_713)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1356.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1356[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1098);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_150.z - originZ,this.var_109.z - originZ,this.var_82.z - originZ,this.var_110.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2169 = relativeDepth;
            this._isVisible = true;
            this.var_1682 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2171);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_124 || this._type == TYPE_LANDSCAPE)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_124 || this._type == TYPE_LANDSCAPE))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_888)
         {
            ...
            {
               _loc4_ = this.var_242[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_888)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_336.length)
            {
               _loc5_ = this.var_336[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_242.length == this.var_886.length)
         {
            while(_loc1_ < this.var_242.length)
            {
               _loc4_ = this.var_242[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_886.length)
                  {
                     _loc7_ = this.var_886[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_336.length > this.var_1357.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_888 || this.var_242.length == 0 && this.var_336.length == 0 && !this.var_337 || this.var_714 == null)
         {
            return;
         }
         ...
         if(this.var_337)
         {
            ...
            while(_loc5_ < this.var_242.length)
            {
               _loc3_ = this.var_242[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc3_.leftSideLoc / this.var_290.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc3_.rightSideLoc / this.var_291.length;
                  _loc12_ = _loc3_.type;
                  this.var_714.updateMask(this.var_68,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_886.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_336.length)
            {
               _loc4_ = this.var_336[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc4_.leftSideLoc / this.var_290.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc4_.rightSideLoc / this.var_291.length;
                  _loc13_ = this.var_68.width * _loc4_.leftSideLength / this.var_290.length;
                  _loc14_ = this.var_68.height * _loc4_.rightSideLength / this.var_291.length;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_217.copyChannel(param1,param1.rect,const_648,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_217.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_217,this.var_217.rect,const_648,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
