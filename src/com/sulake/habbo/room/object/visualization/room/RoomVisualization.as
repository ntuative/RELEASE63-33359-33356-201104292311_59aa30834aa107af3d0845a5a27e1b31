package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1758:int = 16777215;
      
      public static const const_1705:int = 13421772;
      
      private static const const_986:int = 16777215;
      
      private static const const_987:int = 13421772;
      
      private static const const_988:int = 10066329;
      
      private static const const_989:int = 10066329;
      
      public static const const_1695:int = 16777215;
      
      public static const const_1815:int = 13421772;
      
      public static const const_1581:int = 10066329;
      ...
      private var var_724:Rectangle = null;
      
      private var var_492:RoomPlaneBitmapMaskParser = null;
      
      private var var_1414:String = null;
      ...
      private var var_2247:int = 255;
      
      private var var_2245:int = 255;
      
      private var var_2249:int = 255;
      
      private var var_1689:Boolean = true;
      
      private var var_1690:int = 0;
      
      private var var_1813:int = -1000;
      
      private const const_2130:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_492 = new RoomPlaneBitmapMaskParser();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_145 != null)
         {
            ...
            {
               _loc4_ = this.var_145[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_724 = super.boundingRectangle;
         }
         return new Rectangle(this.var_724.x,this.var_724.y,this.var_724.width,this.var_724.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_145.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_145[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1265);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_232,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_186)
            {
               ...
               {
                  _loc13_.color = const_986;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_987;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_346)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1616)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_124,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_346)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1813 + this.const_2130 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_347.length)
            {
               _loc11_ = this.var_593[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_347[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1689)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2249 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2245 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2247 / 255);
         ...
         var_174 = _loc7_.getUpdateID();
         this.var_1813 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1682)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1380 || _loc3_.y != this.var_2221 || _loc3_.z != this.var_2220 || param1.scale != this.var_2218))
            {
               this.var_1380 = _loc3_.x;
               this.var_2221 = _loc3_.y;
               this.var_2220 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_174 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1155);
            if(_loc3_ != this.var_2248)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2248 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_785));
            if(_loc4_ != this.var_1130)
            {
               this.var_1130 = _loc4_;
               this.var_2249 = this.var_1130 & 255;
               this.var_2245 = this.var_1130 >> 8 & 255;
               this.var_2247 = this.var_1130 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1114));
            if(_loc5_ != this.var_1689)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_174 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_208);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_904));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_807));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_910));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_145.length)
         {
            _loc5_ = this.var_145[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_232 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_347;
         if(this.var_347.length == 0)
         {
            _loc6_ = this.var_145;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_347.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_232)
                        {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_347.push(_loc12_);
                        this.var_593.push(_loc9_);
                     }
                  }
               }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_492.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_145.length)
         {
            _loc3_ = this.var_145[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_492.maskCount)
         {
            _loc10_ = this.var_492.getMaskType(_loc8_);
            _loc11_ = this.var_492.getMaskLocation(_loc8_);
            _loc12_ = this.var_492.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_145.length)
               {
                  _loc3_ = this.var_145[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_124 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_124 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_276)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_145[_loc18_] as RoomPlane;
