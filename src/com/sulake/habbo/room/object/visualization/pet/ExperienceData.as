package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class ExperienceData
   {
      ...
      {
         if(this.var_2420 == param1 || this.var_85 == null)
         {
            return;
         }
         this.var_85.copyPixels(this._copy,this._copy.rect,new Point(0,0));
         ...
         this.var_85.draw(_loc3_,_loc4_);
      }
   }
}
