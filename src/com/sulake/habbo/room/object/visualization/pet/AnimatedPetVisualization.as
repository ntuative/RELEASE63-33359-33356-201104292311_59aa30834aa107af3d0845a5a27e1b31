package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1335:String = "head";
      
      private static const const_649:int = 1;
      
      private static const const_985:int = 1000;
      
      private static const const_1333:String = "pet_experience_bubble_png";
      
      private static const const_1334:int = 0;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_905 = [];
         super();
         while(this.var_111.length < ANIMATION_INDEX_COUNT)
         {
            this.var_111.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_111 != null)
         {
            ...
            {
               _loc2_ = this.var_111[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1333) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_346 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2238)
            {
               this.var_2238 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_243);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_144);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_243);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_144);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1893 = _loc3_.getNumber(RoomObjectVariableEnum.const_420) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_210);
            if(!isNaN(_loc8_))
            {
               this.var_1687 = _loc8_;
            }
            else
            {
               this.var_1687 = direction;
            }
            this.var_1383 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2222 = _loc3_.getNumber(RoomObjectVariableEnum.const_827);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_952);
            if(_loc9_ != this.var_1688)
            {
               this.var_1688 = _loc9_;
               this.var_2237 = this.var_1688.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_346 != null)
         {
            ...
            if(this.var_1383 > 0)
            {
               _loc2_ = param1 - this.var_1383;
               if(_loc2_ < const_985)
               {
                  this.var_346.alpha = int(Math.sin(_loc2_ / const_985 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_346.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_346.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_259)
         {
            this.var_259 = param1;
            _loc3_ = this._animationData.getAnimationForPosture(var_88,param1);
            this.setAnimationForIndex(const_1334,_loc3_);
         }
         if(param2 != this.var_1454)
         {
      ...
      {
         return super.getAdditionalSpriteCount() + const_649;
      }
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1384 = false;
         var _loc1_:int = this.var_111.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_111[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function updateAnimations(param1:Number) : int
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_111.length)
         {
            _loc5_ = this.var_111[_loc4_];
            if(_loc5_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_111.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_111[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2237);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_649)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_649))
            {
               if(param2 >= FurnitureVisualizationData.const_588.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_588[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1687);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_88,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1335)
            {
               this.var_905[param1] = true;
            }
            else
            {
               this.var_905[param1] = false;
            }
         }
