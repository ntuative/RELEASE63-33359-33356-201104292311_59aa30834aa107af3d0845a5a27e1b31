package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1570:String = "cone";
      
      public static const const_1757:String = "plane";
      
      public static const const_1813:String = "sphere";
      ...
      public function reset() : void
      {
         ...
         this.var_1030 = 0;
         this.var_947 = false;
         this.init(0,0,0,this._direction,this.var_2749,this.var_1029,this.var_2750,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1273.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_947 = true;
         if(this.var_1030 < this.var_1566)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2746)
         {
            switch(this.var_2747)
            {
               case const_1570:
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1273.length);
         return this.var_1273[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1030 < this.var_1566)
         {
            if(this.age % this.var_2748 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1030 < this.var_1566)
         {
            ...
            this.y = (2 - this.var_276) * this.y - (1 - this.var_276) * this.lastY + this.var_2006 * this.var_1029 * this.var_1029;
         ...
         for each(_loc2_ in this.var_386)
         {
            ...
            _loc2_.y = (2 - this.var_276) * _loc2_.y - (1 - this.var_276) * _loc2_.lastY + this.var_2006 * this.var_1029 * this.var_1029;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_386.splice(this.var_386.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
