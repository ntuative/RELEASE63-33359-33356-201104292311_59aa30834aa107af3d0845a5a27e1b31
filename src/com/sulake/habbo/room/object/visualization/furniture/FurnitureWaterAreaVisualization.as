package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1443:String = "shore";
      ...
      {
         if(this.var_2671 == param1 && this.var_2670 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(method_3(param1,direction,_loc2_) == const_1443)
            {
               this.var_1951 = _loc2_;
               this.var_2671 = param1;
               this.var_2670 = direction;
               return this.var_1951;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1244.indexOf(_loc2_) < 0)
            {
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_657[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_657[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_537 == 0 || this.var_658 == 0)
         {
            ...
            this.var_658 = _loc2_.getNumber(RoomObjectVariableEnum.const_384);
         }
         this.var_448 = [];
         this.var_657 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_537 * 2 + this.var_658 * 2)
         {
            this.var_448.push(false);
            this.var_657.push(ShoreMaskCreatorUtility.const_80);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_68,getSize(param3),this.var_448,this.var_657,assetCollection);
      }
