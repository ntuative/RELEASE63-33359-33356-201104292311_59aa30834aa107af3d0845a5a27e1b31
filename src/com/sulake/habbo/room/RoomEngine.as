package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_671:String = "temporary_room";
      
      private static const const_366:int = -1;
      
      private static const const_672:String = "room";
      
      private static const const_1046:int = -2;
      
      private static const const_1472:String = "tile_cursor";
      
      private static const const_1047:int = -3;
      
      private static const const_1471:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_367:String = "object_icon_sprite";
      
      private static const const_460:int = 15;
      ...
      private var var_1023:IRoomRendererFactory = null;
      
      private var var_831:IRoomObjectFactory = null;
      
      private var var_514:IRoomObjectVisualizationFactory = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_514.release(new IIDRoomObjectVisualizationFactory());
            this.var_514 = null;
         }
         ...
         {
            this.var_1023.release(new IIDRoomRendererFactory());
            this.var_1023 = null;
         }
      ...
      public function method_5(param1:int, param2:int) : String
      {
         var _loc3_:RoomInstanceData = this.getRoomInstanceData(param1,param2);
         if(_loc3_ != null)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            _loc2_ = this._roomManager.getRoom(this.getRoomIdentifier(this.var_93,this.var_92));
      ...
      {
         this.var_1267 = false;
         if(this.var_542 && this.var_542.length > 0)
         {
      ...
      public function requestMouseCursor(param1:String, param2:int, param3:String) : void
      {
         ...
         switch(param1)
         {
            case RoomObjectFurnitureActionEvent.const_373:
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         if(param1 == RoomObjectCategoryEnum.const_26)
         {
            param2 *= -1;
         }
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_1025 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         while(_loc2_ < this.var_314.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_93 || _loc6_ != this.var_92 || !this.var_1268)
                  {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_913) - 0.5;
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_942) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_968) + 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_762) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_514 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_13 != null)
         {
            this.var_13.visualizationFactory = this.var_514;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_307);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1023 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_1024 != null)
            {
               this.var_1024.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.initialize(events,this.var_136);
         }
         this.var_2735 = this.var_136.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_296.events.addEventListener(AdEvent.const_644,this.showRoomAd);
         this.var_296.events.addEventListener(AdEvent.const_810,this.onRoomAdImageLoaded);
         this.var_296.events.addEventListener(AdEvent.const_855,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_421;
      }
      ...
      {
         if(this.var_831 == null || this.var_514 == null || this._roomManager == null || this.var_1023 == null || this._communication == null || this.var_136 == null || !this.var_2733)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_543 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_876,0,0));
            _loc2_ = 0;
      ...
      {
         return this.isPublicRoomWorldType(this.method_5(param1,param2));
      }
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1239,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1239);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         var _loc9_:IRoomInstance = this.createRoom(_loc4_,param3,_loc6_,_loc7_,_loc8_,this.method_5(param1,param2));
         if(_loc9_ == null)
         {
            return;
         }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_366,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1225,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_826,1,true);
            _loc12_ = parseInt(this.var_136.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1126,_loc12_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_366,const_672,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_826,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_688,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_968,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_942,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_762,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1265,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_960,param3);
            ...
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_760,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_208,param5);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_474,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_276);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_784,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_889,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_784,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_889,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1163,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1255,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_1046,const_1472,RoomObjectCategoryEnum.const_307);
         if(this.var_136.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1047,const_1471,RoomObjectCategoryEnum.const_307);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_366,RoomObjectCategoryEnum.const_83);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null, param6:Boolean = false) : Boolean
      {
         ...
         if(param3 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_960,param3);
         ...
         if(param5 != null)
         {
            if(_loc8_ != null && !param6)
            {
               _loc8_.setString(RoomObjectVariableEnum.const_208,param5);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_760,param5);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1690,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1264,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_1023.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1090;
         ...
         {
            _loc12_ = this.method_5(param1,param2);
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_688);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_784);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_889);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1163);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1255);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         var _loc9_:int = param3 - this.var_1560;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1268 = true;
               this.var_832 = false;
               this.var_2734 = this.var_1561;
               this.var_2732 = this.var_1560;
            }
         }
         else if(param4 == MouseEvent.MOUSE_UP)
         {
            if(this.var_1268)
            {
               ...
               if(this.var_832)
               {
                  _loc10_ = this.getRoomInstanceData(this.var_93,this.var_92);
                  if(_loc10_ != null)
                  {
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1268)
            {
               if(!this.var_832)
               {
                  _loc8_ = param2 - this.var_2734;
                  _loc9_ = param3 - this.var_2732;
                  if(_loc8_ <= -const_460 || _loc8_ >= const_460 || _loc9_ <= -const_460 || _loc9_ >= const_460)
                  {
                     this.var_832 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_92,param1);
         if(_loc9_ != null)
         {
            _loc10_ = this.getOverlaySprite(_loc9_);
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_367);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_575,this.var_93,this.var_92,-1,RoomObjectCategoryEnum.const_182));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_64 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_366,const_672);
                     this.var_64.handleRoomObjectEvent(_loc14_,this.var_93,this.var_92);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc5_ = this.getRoomObjectImage(this.var_93,this.var_92,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_92,this.var_1562);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_367);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_367,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1561 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1560 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function method_4(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_92,this.var_1562);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_367);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_92,this.var_1562);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_367);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_64 != null)
         {
            return this.var_64.modifyRoomObject(this.var_93,this.var_92,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:Map) : Boolean
      {
         if(this.var_64 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_64.modifyRoomObjectData(this.var_93,this.var_92,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_64 != null)
         {
            ...
            {
               return this.var_64.modifyWallItemData(this.var_93,this.var_92,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_64 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_25)
            {
               return this.var_64.deleteWallItem(this.var_93,this.var_92,param1);
            }
         }
         return false;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_93,this.var_92);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_826) != 0)
         {
            return false;
         }
         if(this.var_64 != null)
         {
            return this.var_64.initializeRoomObjectInsert(this.var_93,this.var_92,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_64 != null)
         {
            this.var_64.cancelRoomObjectInsert(this.var_93,this.var_92);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1047,RoomObjectCategoryEnum.const_307);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1046,RoomObjectCategoryEnum.const_307);
      }
      ...
      public function addObjectFurnitureByName(param1:int, param2:int, param3:int, param4:String, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN) : Boolean
      {
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc10_:String = this.method_5(param1,param2);
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_248,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_327,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_380,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_690,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1247,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1116,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_390,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_248,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_327,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_380,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1090,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_390,param1,param2,param3,RoomObjectCategoryEnum.const_25));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1291) > 0)
               {
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_914,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_390,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
         return true;
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_744,this.var_93,this.var_92,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_64 != null)
         {
            this.var_64.handleRoomObjectEvent(param1,this.var_93,this.var_92);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_25:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_359);
                     break;
                  case RoomObjectCategoryEnum.const_33:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_212);
               }
            }
         }
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_195,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               ...
               _loc8_.addPlane(RoomPlaneData.const_346,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.method_6();
               ...
               param1.getModelController().setString(RoomObjectVariableEnum.const_208,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_474,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         _loc10_.id = -1;
         if(!this.var_543 || param1 == null)
         {
            return _loc10_;
         }
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_671);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_671,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_833.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_26:
            case RoomObjectCategoryEnum.const_25:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_248,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_359,param7);
               break;
            case RoomObjectCategoryEnum.const_33:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc14_.getModelController().setString(RoomObjectVariableEnum.const_212,param2);
               }
               else
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_952,int(param2));
               }
               break;
         ...
         if(param8 > -1)
         {
            _loc18_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_100);
         ...
         {
            this.var_1269.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1192,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_833.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_93,this.var_92,const_366,RoomObjectCategoryEnum.const_83,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_671);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1192);
               ...
               this.var_833.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1269.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            _loc2_ = this.method_5(param1.roomId,param1.roomCategory);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_383,param1.image,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1304,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1290,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1129,RoomObjectVariableEnum.const_383,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         ...
         {
            this.var_296.loadRoomAdImage(param1,param2,param3,param4);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_810:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1082,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_855:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1279,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
