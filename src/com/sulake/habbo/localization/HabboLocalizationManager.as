package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private var var_1783:Dictionary;
      ...
      {
         this.var_1783 = new Dictionary();
         this.var_2422 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1782 = (param2 & 0) > 0;
         if(!this.var_1782)
         {
            lock();
         }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1782)
            {
               if("WiredFurniTriggerMessageParser" == this.var_177.getKey("use.default.localizations","WiredFurniTriggerMessageParser"))
               {
      ...
      {
         this.var_1783[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1783[param1];
      }
      ...
      {
         return this.var_2422[Math.max(0,param1 - 1)];
      }
   }
}
