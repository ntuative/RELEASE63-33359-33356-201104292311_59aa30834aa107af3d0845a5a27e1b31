package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2436:FriendListLookAndFeel;
      
      private var var_408:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1789:OpenedToWebPopup;
      ...
      private var var_1788:AvatarSearchResults;
      ...
      {
         this.var_2436 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_101 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1788 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_606.stop();
            this.var_606.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_606 = null;
         }
         ...
         if(this.var_129)
         {
            this.var_129.release(new IIDHabboMessenger());
            this.var_129 = null;
         }
         if(this.var_177)
         {
         ...
         if(this.var_1173)
         {
            this.var_1173.release(new IIDAvatarRenderManager());
            this.var_1173 = null;
         }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1789 = new OpenedToWebPopup(this);
         }
         this.var_1789.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_104);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_360);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_322,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1173.createAvatarImage(param1,AvatarScaleType.const_95,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_129 = param2 as IHabboMessenger;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         this._view = new FriendListView(this,this.var_177);
         ...
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_1301,this.getText("friendlist.friends")));
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_440,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_101.addFriend(new Friend(_loc4_));
         }
         this.var_408 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_606)
         {
            this.var_606 = new Timer(120000);
            this.var_606.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_606.start();
         }
         ...
         {
            _loc5_ = this.var_101.findCategory(FriendCategory.const_440);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_408.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_408.findTab(FriendListTab.const_91).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_408.findTab(FriendListTab.const_91);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1788.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_408.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_756 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_756.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_45))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_756.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_170) as IBitmapWrapperWindow;
