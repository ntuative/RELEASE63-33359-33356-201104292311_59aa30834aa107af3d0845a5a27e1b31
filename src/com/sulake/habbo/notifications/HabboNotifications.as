package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1491:String = "pixelbalance";
      
      private static const const_1487:String = "badges";
      
      private static const const_1488:String = "selectbadge";
      
      private static const const_1492:String = "inventory";
      
      private static const const_1485:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1486:String = "friendlist";
      
      private static const const_1490:String = "pet_inventory";
      
      private static const const_1489:String = "go_to_room";
      ...
      private var var_842:IHabboToolbar;
      ...
      private var var_390:HabboNotificationViewManager;
      ...
      private var var_1037:ClubEndingNotification;
      
      private var var_1038:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1036);
         }
         var _loc6_:Map = this.var_1036["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_842)
         {
            this.var_842.release(new IIDHabboToolbar());
            this.var_842 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1036["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      {
         this.var_842 = IHabboToolbar(param2);
         this.var_842.events.addEventListener(HabboToolbarEvent.const_72,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_72)
         {
            ...
            this.var_390 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_1036["styles"],this.var_1036["view"],this.var_842);
            ...
            registerUpdateReceiver(this.var_390,1);
            registerUpdateReceiver(this,2);
            this.var_421.events.addEventListener(BadgeImageReadyEvent.const_151,this.onBadgeImage);
            this.var_842.events.addEventListener(HabboToolbarEvent.const_591,this.onToolbarRepositionEvent);
         }
      }
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_390)
         {
            this.var_390.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1576[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_421);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1576[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1576[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_421.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1168,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1168,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1682,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_497.createAvatarImage(param2,AvatarScaleType.const_53);
         if(_loc7_ != null)
         {
      ...
      private function onRoomMessagesNotification(param1:RoomMessageNotificationMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,_loc4_,_loc6_);
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_421.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_63)
               {
                  _loc7_ = this.var_421.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_421.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1640,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_63:
               ...
               break;
            case CatalogPageMessageProductData.const_219:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1154)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1775,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1786)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_1037 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1038 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_390.isSpaceAvailable() && this.var_1284.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_390.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1487:
               ...
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_317);
               }
               break;
            case const_1488:
               break;
      ...
      {
         if(param1 != null && this.var_390 != null)
         {
            this.var_390.replaceIcon(param1);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_497.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_53);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2777)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1229,null);
            this.var_2777 = true;
      ...
      {
         if(param2.type == WindowEvent.const_189 || param2.type == WindowEvent.const_488)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         this.var_1035 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1229,_loc6_);
      }
   }
}
