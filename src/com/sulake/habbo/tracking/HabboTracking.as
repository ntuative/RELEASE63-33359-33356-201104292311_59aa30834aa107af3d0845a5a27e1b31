package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_980:uint = 11;
      ...
      private var var_1104:IHabboWindowManager;
      ...
      private var var_243:PerformanceTracker = null;
      
      private var var_414:FramerateTracker = null;
      
      private var var_244:LatencyTracker = null;
      
      private var var_585:LagWarningLogger = null;
      
      private var var_584:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_243 = new PerformanceTracker();
         this.var_414 = new FramerateTracker();
         this.var_244 = new LatencyTracker();
         this.var_585 = new LagWarningLogger();
         this.var_584 = new ToolbarClickTracker(this);
         this.var_1363 = new Array(const_980);
         var _loc4_:int = 0;
         while(_loc4_ < const_980)
         {
            this.var_1363[_loc4_] = 0;
            _loc4_++;
         }
         var _loc5_:IContext = param1.root;
         if(_loc5_ != null)
         {
            _loc5_.events.addEventListener(Component.COMPONENT_EVENT_ERROR,this.method_11);
            _loc5_.events.addEventListener(Component.COMPONENT_EVENT_RUNNING,this.onCoreRunning);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1779,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1530,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1550,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_931,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1151,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1104)
            {
               this.var_1104.release(new IIDHabboWindowManager());
               this.var_1104 = null;
            }
            if(this.var_296)
            {
            ...
            if(this.var_198)
            {
               if(!this.var_198.disposed)
               {
                  ...
                  Component(this.var_198).events.removeEventListener(HabboFriendListTrackingEvent.const_427,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_194,this.onRoomAdClick);
            ...
            {
               this.var_288.stop();
               this.var_288.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_288 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_177)
         {
            if(this.var_244 != null)
            {
               this.var_244.configuration = this.var_177;
            }
            if(this.var_243 != null)
            {
            ...
            this.trackLoginStep(HabboLoginTrackingStep.const_1707);
            if(this.var_177)
            {
               if(this.var_585 != null)
               {
                  this.var_585.configure(this.var_177);
               }
               if(this.var_414 != null)
               {
                  this.var_414.configure(this.var_177);
               }
               if(this.var_584 != null)
               {
                  this.var_584.configure(this.var_177);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_869,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_241,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_221,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_213,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_259,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_735,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_73,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_531,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_244 != null)
            {
               this.var_244.communication = this._communication;
               this.var_244.connection = param1;
            }
            if(this.var_585 != null)
            {
               this.var_585.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_735)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1804);
         }
         else if(param1.type == HabboHotelViewEvent.const_531)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1718);
         }
         else if(param1.type == HabboHotelViewEvent.const_73)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1784);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_869:
               this.trackLoginStep(HabboLoginTrackingStep.const_1673,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_241:
               this.trackLoginStep(HabboLoginTrackingStep.const_241);
               break;
            case HabboCommunicationEvent.const_213:
               this.trackLoginStep(HabboLoginTrackingStep.const_213);
               break;
      ...
      {
         this.var_1104 = IHabboWindowManager(param2);
         if(this.var_1104)
         {
      ...
      private function method_11(param1:ErrorEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc4_:* = null;
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_177)
            {
               if(this.var_177.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(this.var_243 != null)
                  {
                     _loc4_["null"] = this.var_243.flashVersion;
                     _loc4_["null"] = this.var_243.averageUpdateInterval;
                  }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_198).events.addEventListener(HabboFriendListTrackingEvent.const_427,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1151,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_931,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_194,this.onRoomAdClick);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_296.events.addEventListener(AdEvent.const_644,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_304)
         {
            if(this.var_1652 < 1)
            {
               if(!this.var_288)
               {
                  this.var_288 = new Timer(60000,1);
                  this.var_288.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_288.start();
               }
            }
         }
            ...
            if(this._connection)
            {
               if(this.var_414)
               {
                  ...
                  if(this._roomEngine)
                  {
                     ...
                     _loc4_ = this._roomEngine.getRoomObjectCount(-1,-1,RoomObjectCategoryEnum.const_26) + this._roomEngine.getRoomObjectCount(-1,-1,RoomObjectCategoryEnum.const_25);
                     _loc2_ = "Avatars: " + _loc3_ + ", Objects: " + _loc4_;
                  }
                  this.trackConversionPoint("Performance","fps",String(this.var_414.frameRate),_loc2_);
                  ++this.var_1652;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_584)
         {
            this.var_584.track(param1.iconName);
         }
      }
      ...
      {
         this.var_585.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_483 > -1 && _loc2_ < this.var_483)
         {
            ++this.var_1651;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1651);
         }
         if(this.var_483 > -1 && _loc2_ - this.var_483 > 15000)
         {
            ++this.var_1653;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1653);
         }
         this.var_483 = _loc2_;
         if(this.var_243 != null)
         {
            this.var_243.update(param1,this.var_483);
         }
         if(this.var_244 != null)
         {
            this.var_244.update(param1,this.var_483);
         }
         if(this.var_414 != null)
         {
            this.var_414.trackUpdate(param1,this,this.var_483);
         }
         if(this.var_585 != null)
         {
            this.var_585.update(this.var_483);
         }
      }
   }
}
