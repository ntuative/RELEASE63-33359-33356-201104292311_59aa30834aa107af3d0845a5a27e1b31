package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1235:BitmapData = null;
      
      private var var_1236:BitmapData = null;
      ...
      public function AdManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(AdImageEvent.const_171,this.onLoadAdImage);
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2644 = this._config.getKey("interstitial.enabled","WiredFurniTriggerMessageParser") == "true";
         this.var_2646 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2647 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1932 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_227 != null && this.var_227.running)
         {
            this.var_227.reset();
            return false;
         }
         if(this.var_1234 == 0)
         {
            this.var_1234 = getTimer();
            return false;
         }
         if(this.var_1932 > 0 && this.var_1933 >= this.var_1932)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1234;
         if(_loc1_ > this.var_2646)
         {
            ++this.var_1933;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1514 = _loc2_.imageUrl;
         this.var_2645 = _loc2_.clickUrl;
         this.var_1234 = getTimer();
         if(this.var_1514 != "")
         {
            _loc3_ = this.var_1514;
            ...
            {
               this.var_227 = new Timer(this.var_2647,1);
               this.var_227.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_227.running)
            {
               this.var_227.reset();
            }
            this.var_227.start();
            _loc4_ = new URLRequest(this.var_1514);
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_47,this.interstitialLoaderEventHandler);
         }
         else
         {
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_622,0,0,param1.bitmapData,this.var_2645));
            this.var_1234 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_595));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1515 = _loc2_.imageUrl;
         this.var_1934 = _loc2_.clickUrl;
         if(this.var_1515 != "" && this.var_1934 != "")
         {
            _loc3_ = this.var_1515;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1515);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_644,0,0,_loc4_,_loc2_.assetName,this.var_1934,this.var_1235,this.var_1236));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1235 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1236 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdImageEvent(AdImageEvent.const_171,param3,param4,param1,param2));
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_650.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_650.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_28,this.onBillboardImageReady);
         _loc5_.addEventListener(AssetLoaderEvent.const_47,this.onBillboardImageLoadError);
      }
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_650.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_810,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_650.remove(_loc2_.assetName);
