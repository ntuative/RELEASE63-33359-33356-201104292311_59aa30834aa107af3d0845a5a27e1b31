package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2116:int = 2500;
      ...
      private var var_1103:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1103 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1103.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1362));
         this.var_1361.add(this.var_1362,getTimer());
         ++this.var_1362;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1361.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2116)
            {
      ...
      public function method_13(param1:int, param2:int, param3:Array) : void
      {
      ...
      {
         return this.var_1103 as IUserDataManager;
      }
