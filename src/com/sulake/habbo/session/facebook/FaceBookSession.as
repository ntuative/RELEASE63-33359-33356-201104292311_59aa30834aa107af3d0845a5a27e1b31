package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1006:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1379:String = "sendAccessTokenToServer";
      
      private static const const_1380:String = "fbKLogOut";
      ...
      public function set communication(param1:IHabboCommunicationManager) : void
      {
         ...
         this._connection.addHabboConnectionMessageEvent(new FaceBookErrorEvent(this.method_11));
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1379,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1380,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1006);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1006);
         }
      }
      ...
      private function method_11(param1:FaceBookErrorEvent) : void
      {
      }
