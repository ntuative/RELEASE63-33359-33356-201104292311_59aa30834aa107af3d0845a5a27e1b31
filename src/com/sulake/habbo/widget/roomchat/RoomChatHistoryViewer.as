package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1477:int = 18;
      
      private static const SCROLLBAR_WIDTH:int = 20;
      
      public static const const_1153:int = 3;
      ...
      private var var_460:Number = -1;
      
      private var var_50:IScrollbarWindow;
      
      private var var_676:Number = 1;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_192.state = RoomChatHistoryPulldown.const_284;
         ...
         this.var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_1236,HabboWindowStyle.const_43,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_192.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_284);
      }
      ...
      {
         return !!this.var_461 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_192.state == RoomChatHistoryPulldown.const_434 || this.var_192.state == RoomChatHistoryPulldown.const_638;
      }
      ...
      {
         if(!this.var_461 && !this.var_1762)
         {
            this.var_461 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_192.state = RoomChatHistoryPulldown.const_434;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_50 != null)
         {
            ...
            if(param2)
            {
               this.var_50.scrollV = this.var_676;
            }
         }
         if(this.var_192 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_460 > 0 && param2)
         {
            if(this.var_2022)
            {
               if(Math.abs(param1 - this.var_460) <= const_1153)
               {
                  return;
               }
               this.var_2022 = false;
            ...
            if(this.var_461)
            {
               ...
               _loc5_ = (param1 - this.var_460) / this.var_50.height;
               _loc3_ = this.var_676 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_460;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_50.scrollV < 1 - const_1477 / this.var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_2021)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_50 != null)
         {
            this.var_676 = this.var_50.scrollV;
         }
         if(this.var_50 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_676 - this.var_50.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
