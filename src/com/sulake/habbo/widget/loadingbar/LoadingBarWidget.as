package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_512:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_512.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_512 = null;
         }
         if(this.var_46 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_512 == null)
         {
            ...
            this.var_512.addChild(new Bitmap(this.var_46));
            this.var_512.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_512.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_46;
            }
         }
         _loc2_.setDisplayObject(this.var_512);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1145 != "")
         {
            HabboWebTools.openWebPage(this.var_1145);
         }
      }
   }
}
