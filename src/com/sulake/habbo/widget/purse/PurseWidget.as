package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_1843:int = 3;
      
      private const const_2117:uint = 4.291993382E9;
      
      private const const_2118:uint = 4.29080704E9;
      
      private const const_2120:uint = 4.285767869E9;
      
      private const const_2119:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager)
      {
         ...
         if(_loc4_)
         {
            ...
            this._view.x = _loc5_.width - this._view.width - this.const_1843;
            this._view.y = this.const_1843;
            ...
            for each(_loc7_ in _loc6_)
            {
               ...
               _loc7_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onOrangeMouseOut);
            }
            _loc6_ = [];
            ...
            for each(_loc7_ in _loc6_)
            {
               ...
               _loc7_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onBlueMouseOut);
            }
         }
      }
      ...
      {
         this.var_1661 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1661.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1661.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_1660 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1660.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1660.toString();
         }
      }
      
      private function onCreditsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1139));
      }
      
      private function onPixelsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1208));
      }
      
      private function onOrangeMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2118;
      }
      
      private function onOrangeMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2117;
      }
      
      private function onBlueMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2119;
      }
      
      private function onBlueMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2120;
      }
   }
}
