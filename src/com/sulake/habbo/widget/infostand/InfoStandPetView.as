package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_200:PetCommandTool;
      
      private var _petData:Map;
      
      private var var_513:int;
      
      private const const_2143:int = 152;
      
      private const const_2139:int = 16;
      
      private const const_1341:int = 4;
      
      private const const_2137:uint = 14342874;
      
      private const const_2141:uint = 3815994;
      
      private const const_2145:uint = 2085362;
      
      private const const_2144:uint = 39616;
      
      private const const_2142:uint = 10513106;
      
      private const const_2135:uint = 8734654;
      
      private const const_2136:uint = 9094430;
      
      private const const_2138:uint = 6200576;
      
      private const const_2140:String = "happiness";
      
      private const const_2146:String = "experience";
      
      private const const_2147:String = "energy";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2140,param1.nutrition,param1.nutritionMax,this.const_2144,this.const_2145);
         this.updateStateElement(this.const_2146,param1.experience,param1.experienceMax,this.const_2135,this.const_2142);
         this.updateStateElement(this.const_2147,param1.energy,param1.energyMax,this.const_2138,this.const_2136);
         ...
         this.updateWindow();
         this.var_513 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_200 && this.var_200.isVisible() && param1.isOwnPet)
         {
            this.var_200.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_200.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2143,this.const_2139,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2137);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2141);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1341,_loc7_.width - 2,_loc7_.height - 2 - this.const_1341);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1341);
      ...
      private function openTrainView() : void
      {
         if(this.var_200 == null)
         {
            this.var_200 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_513) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_200.showWindow(true);
            this.var_200.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for each(_loc10_ in _loc4_)
         {
            ...
            _loc10_.addEventListener(WindowEvent.const_37,this.onButtonResized);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_200 && this.var_200.getPetId() == this.var_513)
               {
                  this.var_200.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
