package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_96:IWindowContainer;
      
      private var var_47:IBorderWindow;
      
      private var var_1248:TagListRenderer;
      
      private var var_134:IBorderWindow;
      
      private var var_2562:int;
      
      private var var_2563:Boolean = true;
      
      private const const_1030:int = 5;
      
      private const const_1869:int = 7829367;
      
      private const const_1870:int = 16777215;
      
      private const const_2162:int = 2000;
      
      private const const_2163:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1248 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2563 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:* = [];
         this.var_96.groupChildrenWithTag("CMD_BUTTON",_loc3_,true);
         for each(_loc4_ in _loc3_)
         {
            ...
            _loc4_.addEventListener(WindowEvent.const_37,this.onButtonResized);
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_134.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_134.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_134.x = _loc5_.left - this.var_134.width;
         this.var_134.y = _loc5_.top + (_loc5_.height - this.var_134.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_134.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_134.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_134.x = _loc7_.left - this.var_134.width;
         this.var_134.y = _loc7_.top + (_loc7_.height - this.var_134.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_134 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_134 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1030;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1869;
            }
            else
            {
               _loc3_.textColor = this.const_1870;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_1030,this.const_2163);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_313,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_313,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1248.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_127);
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_96.getChildByName(param1) as IRegionWindow;
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_778:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2562 > this.const_2162 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2562 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1869;
         }
      }
