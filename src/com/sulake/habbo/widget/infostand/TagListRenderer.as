package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2132:int = 5;
      
      private const const_2131:int = 5;
      ...
      private var var_1134:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1133 = 0;
         this.var_1134 = param2.rectangle.clone();
         this.var_1134.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1134.width)
         {
            return false;
         }
         if(this.var_1133 + param1.height > this.var_1134.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1134.width)
         {
            this._offsetX = 0;
            this.var_1133 += param1.height + this.const_2131;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1133);
         this._offsetX += param1.width + this.const_2132;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1387 != null && this.var_1387.indexOf(param1) != -1)
         {
