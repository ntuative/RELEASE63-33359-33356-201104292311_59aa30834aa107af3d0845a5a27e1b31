package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_377)
         {
            this.var_1875 = param1.songId;
         }
         if(param1.songId == this.var_1875)
         {
            this._songName = param1.songName;
            this.var_2811 = param1.songAuthor;
            this.updateNowPlaying(this.var_1875 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2811;
         }
         else
         {
