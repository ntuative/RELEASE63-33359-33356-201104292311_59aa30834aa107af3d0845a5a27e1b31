package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_239 = this.var_47.findChildByTag("catalog");
      ...
      {
         if(this.var_53 == null || this.var_47 == null || this._buttons == null)
         {
            return;
         }
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1174.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_53.addListItem(this.var_239);
            }
            this.var_239.visible = param1;
         }
         else
         {
            this.var_53.removeListItem(this.var_239);
         }
      }
   }
}
