package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      {
         super.update(param1);
         this.var_1875 = this.getSongIdFromExtraParam(param1.extraParam);
      }
      
      public function updateSongInfo(param1:RoomWidgetSongUpdateEvent) : void
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_417 && param1.songId == this.var_1875)
         {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         if(var_47 != null)
         {
            var_53 = var_47.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         ...
         var_239 = var_47.findChildByTag("catalog");
         if(var_239 != null)
         {
      ...
      private function getSongIdFromExtraParam(param1:String) : int
      {
         ...
         if(param1 != null)
         {
            _loc2_ = param1.substr(RoomWidgetInfostandExtraParamEnum.const_375.length,param1.length);
