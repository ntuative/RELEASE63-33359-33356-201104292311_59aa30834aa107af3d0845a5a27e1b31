package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1850:int = 0;
      
      private const const_1847:int = 1;
      
      private const const_1844:int = 2;
      
      private const const_1845:int = 3;
      
      private const const_1846:int = 4;
      
      private const const_2122:int = 0;
      
      private const const_2128:int = 1;
      
      private const const_2127:int = 2;
      
      private const const_2121:int = 3;
      
      private const const_2124:int = 4;
      
      private const const_2125:int = 5;
      
      private const const_1849:String = "deco_img";
      
      private const const_1848:String = "dialog_bg";
      
      private const const_2129:String = "%campaign%_dialog_bg.png";
      
      private const const_364:String = "%campaign%_gift_package.png";
      
      private const const_2126:String = "%campaign%_gift_content.png";
      
      private const const_2123:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1368 = this.var_136.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1368 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1367.length)
         {
            _loc2_ = this.var_1367.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_136 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_543,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_754,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_957,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_543,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_543:
               _loc2_ = this.const_1850;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_957:
               ...
               this._shareId = null;
               this.var_1369 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_754:
         ...
         if(this._window && (this.var_1366 != _loc2_ || _loc3_ != this.var_178))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_178 = _loc3_;
         this.var_1366 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            switch(this.var_1366)
            {
               case this.const_1850:
               ...
               case this.const_1847:
                  if(this.var_404 == this.const_2122)
                  {
                  ...
                  else if(this.var_404 == this.const_2128)
                  {
                     ...
                     _loc2_ = this.const_2126;
                  }
                  else if(this.var_404 == this.const_2127)
                  {
                  ...
                  else if(this.var_404 == this.const_2121)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_404 == this.const_2124)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_178,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_404 == this.const_2125)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2129.replace("%campaign%",this.var_178);
            this.setDecoImage(_loc5_,this.const_1848);
            _loc2_ = _loc2_.replace("%campaign%",this.var_178);
            this.setDecoImage(_loc2_,this.const_1849);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_786);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_136.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_169);
         ...
         if(this._inventory)
         {
            if(this.var_1369 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1369 == 1 ? "null" : InventoryCategory.const_159);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_872,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1367.push(new ImageDownloader(this,_assets,this.var_178,this.var_1368,param1,param2));
            return;
         }
