package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_623:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_74,HabboWindowStyle.const_29,0 | 0,new Rectangle(const_1340,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_623 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1459 = _loc2_.light;
         if(this.var_435 != null)
         {
            this.var_435.setValue(this.var_1459);
         }
         this.var_494 = this.colors.indexOf(_loc2_.color);
         if(this.var_623 != null)
         {
            this.var_623.setSelectedColorIndex(this.var_494);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1460 = XML(_loc1_.content);
         return this.var_1460;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_623 != null)
         {
            this.var_623.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
