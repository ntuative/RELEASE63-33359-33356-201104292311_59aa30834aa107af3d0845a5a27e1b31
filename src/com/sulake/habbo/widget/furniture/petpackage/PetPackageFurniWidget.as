package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_400,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_400,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomWidgetPetPackageUpdateEvent.const_587:
               this.hideInterface();
               this.var_196 = event.objectId;
               this.var_589 = event.image;
               this.showInterface();
               this.showPetImage();
               break;
            case RoomWidgetPetPackageUpdateEvent.const_598:
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_400:
               if(event.objectId != this.var_196)
               {
                  return;
               }
               this.var_589 = event.image;
      ...
      {
         var _loc2_:* = null;
         if(this.var_589 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_589.width) / 2,(_loc1_.height - this.var_589.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_589,this.var_589.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1124 || this.var_196 == -1)
         {
            return;
         }
         ...
         {
            this.var_1124 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_733,this.var_196,name);
