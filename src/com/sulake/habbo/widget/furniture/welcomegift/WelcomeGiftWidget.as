package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_660:String = "welcome_gift_email_unverified";
      
      private const const_1010:String = "welcome_gift_email_verified";
      
      private const const_1393:String = "welcome_gift_email_change";
      
      private const const_2159:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1198)
         {
            this.setViewState(this.const_1010);
         }
         else
         {
            this.setViewState(this.const_660);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_660:
               ...
               this._view.findChildByName("edit_text").visible = this.var_955;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_955);
               break;
            ...
            case this.const_1393:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_955);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1461;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1393);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_887,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1198 ? this.const_1010 : this.const_660);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1462 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1462));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_929,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_929,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_600:
               this.var_1461 = param1.email;
               this.var_1198 = param1.isVerified;
               this.var_955 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1461 = this.var_1462;
            this.setViewState(this.const_660);
         }
         else
         {
            if(param1.result == this.const_2159)
            {
               this.var_955 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1462);
