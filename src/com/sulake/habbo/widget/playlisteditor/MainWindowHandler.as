package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MainWindowHandler
   {
      ...
      private static const const_1503:int = 6;
      
      private static const const_1505:int = 9;
      ...
      private var var_1054:IBorderWindow;
      
      private var var_1053:IBorderWindow;
      
      private var var_558:MusicInventoryGridView;
      
      private var var_849:PlayListEditorItemListView;
      
      private var var_235:MusicInventoryStatusView;
      
      private var var_321:PlayListStatusView;
      
      private var var_2059:IScrollbarWindow;
      ...
      public function MainWindowHandler(param1:PlayListEditorWidget, param2:IHabboMusicController)
      {
         ...
         this._widget = param1;
         this.var_219 = param2;
         var _loc3_:Array = [PlayListEditorWidgetAssetsEnum.const_971,PlayListEditorWidgetAssetsEnum.const_701,PlayListEditorWidgetAssetsEnum.const_633,PlayListEditorWidgetAssetsEnum.const_611,PlayListEditorWidgetAssetsEnum.const_723];
         ...
         this.var_849 = new PlayListEditorItemListView(param1,this.getPlayListEditorItemList());
         this.var_235 = new MusicInventoryStatusView(param1,this.getMusicInventoryStatusContainer());
         this.var_321 = new PlayListStatusView(param1,this.getPlayListStatusContainer());
      ...
      public function destroy() : void
      {
         if(this.var_219)
         {
            this.var_219.stop(HabboMusicPrioritiesEnum.const_372);
            this.var_219 = null;
         }
         if(this.var_558)
         {
         ...
         if(this.var_849)
         {
            this.var_849.destroy();
            this.var_849 = null;
         }
         if(this.var_321)
         {
            this.var_321.destroy();
            this.var_321 = null;
         }
         if(this.var_235)
         {
      ...
      {
         this.var_219.requestUserSongDisks();
         var _loc1_:IPlayListController = this.var_219.getRoomItemPlaylist();
         if(_loc1_ != null)
         {
      ...
      {
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_971)
         {
            this.assignWindowBitmapByAsset(this.var_1054,"music_inventory_splash_image",PlayListEditorWidgetAssetsEnum.const_971);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_701)
         {
            this.assignWindowBitmapByAsset(this.var_1053,"playlist_editor_splash_image",PlayListEditorWidgetAssetsEnum.const_701);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_633)
         {
            this.var_235.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_633));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_611)
         {
            this.var_235.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_611));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_723)
         {
            this.var_321.addSongsBackgroundImage = this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_723);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1054 = _loc2_.getChildByName("my_music_border") as IBorderWindow;
         this.var_1053 = _loc2_.getChildByName("playlist_border") as IBorderWindow;
         ...
         this.var_2059 = this.var_1054.getChildByName("music_inventory_scrollbar") as IScrollbarWindow;
         this.var_2058 = this.var_1053.getChildByName("playlist_scrollbar") as IScrollbarWindow;
      ...
      {
         return this.var_1054.getChildByName("music_inventory_itemgrid") as IItemGridWindow;
      }
      
      private function getPlayListEditorItemList() : IItemListWindow
      {
         return this.var_1053.getChildByName("playlist_editor_itemlist") as IItemListWindow;
      }
      
      private function getMusicInventoryStatusContainer() : IWindowContainer
      {
         return this.var_1054.getChildByName("preview_play_container") as IWindowContainer;
      }
      
      private function getPlayListStatusContainer() : IWindowContainer
      {
         return this.var_1053.getChildByName("now_playing_container") as IWindowContainer;
      }
      ...
      private function selectPlayListStatusViewByFurniPlayListState() : void
      {
         ...
         if(_loc1_.isPlaying)
         {
            this.var_321.selectView(PlayListStatusView.const_632);
         }
         else if(_loc1_.length > 0)
         {
            this.var_321.selectView(PlayListStatusView.const_1224);
         }
         else
         {
            this.var_321.selectView(PlayListStatusView.const_890);
         }
      }
      ...
      private function selectMusicStatusViewByMusicState() : void
      {
         ...
         {
            this.var_235.show();
            this.var_235.selectView(MusicInventoryStatusView.const_725);
         }
         else if(this.var_219.getSongDiskInventorySize() <= const_1503)
         {
            this.var_235.show();
            this.var_235.selectView(MusicInventoryStatusView.const_825);
         }
         else
         {
            this.var_235.hide();
      ...
      private function updatePlaylistEditorView() : void
      {
         ...
         this.var_849.refresh(_loc2_,_loc3_);
      }
      ...
      public function onPlayListUpdated() : void
      {
         ...
         if(_loc2_ != -1)
         {
            _loc3_ = this.var_219.getSongInfo(_loc2_);
            this.var_321.nowPlayingTrackName = _loc3_.name;
            this.var_321.nowPlayingAuthorName = _loc3_.creator;
         }
         this.var_2058.visible = _loc1_.length > const_1504;
      }
      ...
      public function onSongDiskInventoryReceived() : void
      {
         ...
         this.var_2059.visible = this.var_558.itemCount > const_1505;
      }
      ...
      public function onNowPlayingChanged(param1:RoomWidgetPlayListEditorNowPlayingEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPlayListEditorNowPlayingEvent.const_105:
               this.selectPlayListStatusViewByFurniPlayListState();
               this.var_849.setItemIndexPlaying(param1.position);
               if(param1.id != -1)
               {
                  _loc3_ = this.var_219.getSongInfo(param1.id);
                  this.var_321.nowPlayingTrackName = _loc3_ != null ? _loc3_.name : "";
                  this.var_321.nowPlayingAuthorName = _loc3_ != null ? _loc3_.creator : "";
               }
               break;
      ...
      {
         return this.var_219.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_372) != -1;
      }
   }
}
