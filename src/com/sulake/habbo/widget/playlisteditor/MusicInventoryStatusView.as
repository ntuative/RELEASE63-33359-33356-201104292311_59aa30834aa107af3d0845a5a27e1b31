package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_725:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_1735:ITextWindow;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_459.getValues())
         {
            _loc1_.destroy();
         }
         this.var_459 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_459[param1] as IWindowContainer,0);
         this.var_44 = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1734.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_725,"preview_play_background_image",param1);
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_459.add(const_725,_loc1_);
            this.var_1735 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1734 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
         ...
         if(_loc1_ != null)
         {
            this.var_459.add(const_825,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_611));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_459[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
