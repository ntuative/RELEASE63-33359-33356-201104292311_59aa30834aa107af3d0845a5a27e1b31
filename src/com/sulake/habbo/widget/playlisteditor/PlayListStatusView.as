package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_890:String = "PLSV_ADD_SONGS";
      
      public static const const_1224:String = "PLSV_START_PLAYBACK";
      
      public static const const_632:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_44 != const_632)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_459[this.var_44];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_459[const_890];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_459.add(const_632,_loc1_);
