   ...
   public class PlayListEditorItemListView
   {
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_581);
            }
            return;
         }
         ...
         if(this.var_1312 >= 0 && this.var_1312 < this._items.length)
         {
            _loc2_ = this._items[this.var_1312] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_581);
         }
