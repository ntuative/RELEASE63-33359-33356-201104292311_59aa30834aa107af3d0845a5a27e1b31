package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2946:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2946 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_409:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_58,this.var_136,this.var_2296++,this,this._questEngine);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               if(this.var_136.getKey("new.chat.widget.enabled") == "1")
               {
                  _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_58,this.var_136,this);
               }
               else
               {
                  _loc2_ = new RoomChatInputWidgetOld(this._windowManager,assets,this.var_58,this.var_136,this);
               }
               break;
            case RoomWidgetEnum.const_481:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_58,this.var_136,this._catalog);
               break;
            case RoomWidgetEnum.const_510:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_58,events,this.var_136);
               break;
            ...
            case RoomWidgetEnum.const_493:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_58,this.var_136,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_529:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_58,this.var_136);
               break;
            case RoomWidgetEnum.const_703:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_58,this.var_136);
               break;
            case RoomWidgetEnum.const_134:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_58,this.var_136);
               break;
            ...
            case RoomWidgetEnum.const_132:
               _loc2_ = new AvatarInfoWidget(this._windowManager,assets,this.var_136,this.var_58,this);
               break;
            ...
            case RoomWidgetEnum.const_551:
               _loc2_ = new PlayListEditorWidget(this._windowManager,this._soundManager,assets,this.var_58,this.var_136,this._catalog);
               break;
