package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1317:uint = 0;
      
      protected static const const_447:uint = 1;
      
      protected static const const_1316:uint = 2;
      
      private static const const_1523:uint = 4282663229;
      
      private static const const_1524:uint = 4283715916;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_578:uint = 0;
      ...
      public function AvatarMenuView(param1:AvatarInfoWidget, param2:int, param3:String, param4:int, param5:int, param6:AvatarInfoData)
      {
         ...
         this._data = param6;
         var_1348 = XmlAsset(_widget.assets.getAssetByName("avatar_menu_widget")).content as XML;
      }
      ...
      override public function dispose() : void
      {
         if(_window)
         {
            ...
            _window.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onMouseHoverEvent);
         }
         super.dispose();
      }
      ...
      override protected function createWindow() : void
      {
         ...
         _window = _widget.windowManager.buildFromXML(var_1348,0) as IWindowContainer;
         if(!_window)
         {
            return;
         }
         _window.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseHoverEvent);
         _window.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT,this.onMouseHoverEvent);
      ...
      protected function updateButtons() : void
      {
         ...
         if(this.var_578 == const_1317 || this.var_578 == const_447)
         {
            ...
            else
            {
               ...
               this.var_578 = const_447;
            }
         }
         if(this.var_578 == const_447)
         {
