package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1495:int = 25;
      ...
      protected var var_2518:int;
      
      protected var var_1348:XML;
      
      protected var var_1349:Boolean;
      
      protected var var_2145:FixedSizeStack;
      ...
      {
         this.var_2145 = new FixedSizeStack(const_1495);
         super();
         this._widget = param1;
         this._userId = param2;
         ...
         this.var_1348 = XmlAsset(this._widget.assets.getAssetByName("avatar_info_widget")).content as XML;
      }
      ...
      protected function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.buildFromXML(this.var_1348,0) as IWindowContainer;
         if(!this._window)
         {
            return;
         }
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_891));
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1349)
         {
            ...
            if(this.var_1623 == RoomObjectTypeEnum.const_172 || this.var_1623 == RoomObjectTypeEnum.const_477)
            {
            ...
            this.var_2145.addValue(_loc5_);
            _loc6_ = this.var_2145.getMax();
            if(_loc6_ < this.var_2146 - const_1057)
            {
               _loc6_ = this.var_2146 - const_1057;
            }
