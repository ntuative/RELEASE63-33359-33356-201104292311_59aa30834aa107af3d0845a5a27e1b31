package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1442:uint = 13232628;
      
      private static var var_1803:uint = 11129827;
      ...
      private var var_1179:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1805 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_762)
         {
            this.var_762 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_762)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_761)
         {
            this.var_761 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_761)
            {
               return;
            }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_511);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_866:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1075:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.change_not_allowed");
               break;
            case ChangeUserNameResultMessageEvent.var_1074:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1074 || param1 == ChangeUserNameResultMessageEvent.var_1075)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1179 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1179.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1442;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_511 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_511);
               break;
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_93);
         }
      }
