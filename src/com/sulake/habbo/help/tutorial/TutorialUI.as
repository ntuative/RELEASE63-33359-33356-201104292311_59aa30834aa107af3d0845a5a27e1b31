package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_355:String = "TUI_NAME_VIEW";
      
      public static const const_378:String = "TUI_CLOTHES_VIEW";
      
      public static const const_569:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_509,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_486,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_563,this.onTaskDoneEvent);
      ...
      {
         return this.var_1127 && this.var_1128 && this.var_1382;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_509,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_486,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_563,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_44 == null || this.var_44.id == const_93)
         {
            this.prepareForTutorial();
            this.showView(const_93);
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_509:
               this.var_1382 = true;
               if(this.var_44 != null && this.var_44.id == const_569)
               {
                  this.showView(const_93);
               }
               break;
            case HabboHelpTutorialEvent.const_486:
               if(this.var_44 != null && this.var_44.id == const_378)
               {
                  this.var_1684 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2235 = this._window.width - _loc2_.width;
         ...
         this._window.width = _loc2_.width + this.var_2235;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_44 != null && (this.var_44.id == const_355 || this.var_44.id == const_93))
         {
            this.showView(const_93);
         }
      }
      ...
      {
         this.var_1127 = true;
         if(this.var_44 != null && (this.var_44.id == const_378 || this.var_44.id == const_93))
         {
            this.showView(const_93);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_1128 = true;
            this.showView(TutorialUI.const_93);
         }
         else
         {
