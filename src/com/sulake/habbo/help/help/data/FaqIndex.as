package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         this.var_770 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_771 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_772 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_161 != null)
         {
            ...
            {
               _loc2_ = this.var_161.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_161.getValue(param1);
      ...
      {
         var _loc4_:* = null;
         if(this.var_770.hasItem(param1))
         {
            this.var_770.getItem(param1).answerText = param2;
         }
         if(this.var_771.hasItem(param1))
         {
            this.var_771.getItem(param1).answerText = param2;
         }
         ...
         {
            _loc4_ = this.var_161.getWithIndex(_loc3_);
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_770.hasItem(param1))
         {
            return this.var_770.getItem(param1);
         }
         if(this.var_771.hasItem(param1))
         {
            return this.var_771.getItem(param1);
         }
         if(this.var_772.hasItem(param1))
         {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_161.length)
         {
            _loc3_ = this.var_161.getWithIndex(_loc2_);
