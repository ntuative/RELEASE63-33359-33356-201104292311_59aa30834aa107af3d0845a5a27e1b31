package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_367 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201104292304));
         this._toolbar = param5;
         this.var_115 = new Map();
         this.var_115.add(HabboHelpViewEnum.const_1766,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_206,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_616,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_334,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_287,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_386,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_847,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_257,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_115.add(HabboHelpViewEnum.const_1283,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_115.add(HabboHelpViewEnum.const_1241,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_115.add(HabboHelpViewEnum.const_969,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_524.length == 0 || param1 != this.var_367)
            {
               this.var_524.push(this.var_367);
            }
         }
         this.var_367 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_257:
               this.showUI(HabboHelpViewEnum.const_257);
               break;
            case CallForHelpResultEnum.const_1191:
               this.showUI(HabboHelpViewEnum.const_1241);
               break;
            case CallForHelpResultEnum.const_1284:
               this.showUI(HabboHelpViewEnum.const_1283);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_115.getValue(HabboHelpViewEnum.const_206) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_509));
      }
      ...
      {
         return this.var_115.getValue(this.var_367);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2235 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2234;
         this._window.width = _loc1_.width + this.var_2235;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_524.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_206)
         {
            return;
         }
         if(this.var_631.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_631.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_631.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_366.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_631[1],this.var_631[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_631[0],this.var_631[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_206 || this.var_524.length == 0)
         {
            return;
         }
         if(this.var_366 == null)
         {
            ...
            this.var_366 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_366.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_366.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_366 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_366 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_366 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
