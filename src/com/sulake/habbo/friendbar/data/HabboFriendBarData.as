package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_659:String = "FriendBar";
      
      private static const const_658:String = "user_interaction";
      
      private static const const_1387:String = "visit_btn_click";
      
      private static const const_1388:String = "chat_btn_click";
      
      private static const const_1385:String = "find_friends_btn_click";
      
      private static const const_1008:String = "Toolbar";
      
      private static const const_1007:String = "open";
      
      private static const const_1009:String = "close";
      
      private static const const_1384:String = "FRIENDLIST";
      
      private static const const_1386:String = "MESSENGER";
       
      
      private var var_86:IHabboCommunicationManager;
      
      private var var_362:IHabboFriendList;
      
      private var var_434:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_86)
            {
               this.var_86.release(new IIDHabboCommunicationManager());
               this.var_86 = null;
            }
            if(this.var_362)
            {
               this.var_362.release(new IIDHabboFriendList());
               this.var_362 = null;
            }
            if(this.var_434)
            {
               this.var_434.release(new IIDHabboMessenger());
               this.var_434 = null;
            }
            this.var_133 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_86)
         {
            this.var_86.getHabboMainConnection(null).send(new FollowFriendMessageComposer(param1));
            this.var_86.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_659,const_658,const_1387));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_434)
         {
            this.var_434.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_86)
            {
               this.var_86.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_659,const_658,const_1388));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_86)
         {
            this.var_86.getHabboMainConnection(null).send(new FindNewFriendsMessageComposer());
            this.var_86.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_659,const_658,const_1385));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         if(this.var_362)
         {
            ...
            {
               if(!this.var_362.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_362.openFriendRequests();
                  }
                  else
                  {
                     this.var_362.openFriendList();
                  }
               }
               else
               {
               ...
               if(this.var_86)
               {
                  this.var_86.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1008,const_1384,!!this.var_362.isOpen() ? const_1007 : const_1009));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_434)
         {
            if(!this.var_434.disposed)
            {
               this.var_434.toggleMessenger();
               if(this.var_86)
               {
                  this.var_86.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1008,const_1386,!!this.var_434.isOpen() ? const_1007 : const_1009));
               }
            }
         }
      }
      ...
      {
         this.var_86 = param2 as IHabboCommunicationManager;
         this.var_86.addHabboConnectionMessageEvent(new MessengerInitEvent(this.onMessengerInitialized));
         this.var_86.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.onFriendListUpdate));
         this.var_86.addHabboConnectionMessageEvent(new FindFriendsProcessResultEvent(this.onFindFriendProcessResult));
         this.var_86.addHabboConnectionMessageEvent(new NewBuddyRequestEvent(this.onNewFriendRequest));
         this.var_86.addHabboConnectionMessageEvent(new BuddyRequestsEvent(this.onFriendRequestList));
         this.var_86.addHabboConnectionMessageEvent(new NewConsoleMessageEvent(this.onNewConsoleMessage));
         this.var_86.addHabboConnectionMessageEvent(new RoomInviteEvent(this.onRoomInvite));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_434 = param2 as IHabboMessenger;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_362 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc8_ in _loc5_)
         {
            ...
            if(_loc3_)
            {
               ...
               this.var_133.splice(this.var_133.indexOf(_loc3_),1);
            }
         }
         ...
         {
            this.var_133 = !!const_297 ? this.sortByNameAndOnlineStatus(this.var_133) : this.sortByName(this.var_133);
         }
