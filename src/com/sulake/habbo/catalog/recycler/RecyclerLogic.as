package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_991:int = 0;
      ...
      {
         return this.var_598 != const_991;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1727 != RecyclerStatusMessageEvent.const_1124;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_598 == const_449;
      }
      ...
      {
         this.var_598 = const_992;
         this.var_113 = new Array(const_193);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1536:
               this.var_598 = const_449;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1124:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1555:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1154:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1561:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_113.length < const_193)
         {
            return false;
         }
         var _loc1_:int = 0;
