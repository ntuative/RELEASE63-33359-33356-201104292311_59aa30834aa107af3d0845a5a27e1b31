package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2134:int = 10;
      ...
      private const const_1892:uint = 4.293848814E9;
      
      private const const_1893:uint = 4.294967295E9;
      
      private const const_1375:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1705 = _loc1_.stuffTypes;
            this.var_731 = _loc1_.boxTypes;
            this.var_732 = _loc1_.ribbonTypes;
            this.var_1137 = this.var_1705[0];
            this.var_348 = this.var_731[0];
            this.var_349 = this.var_732[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_349 < 0)
         {
            this.var_349 = this.var_732.length - 1;
         }
         if(this.var_349 > this.var_732.length - 1)
         {
            this.var_349 = 0;
         }
         if(this.var_348 < 0)
         {
            this.var_348 = this.var_731.length - 1;
         }
         if(this.var_348 > this.var_731.length - 1)
         {
            this.var_348 = 0;
         }
         var _loc1_:int = this.var_731[this.var_348] * 1000 + this.var_732[this.var_349];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_91.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1137,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1389 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1705;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1137);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_731[this.var_348]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_732[this.var_349]);
         this._catalog.purchaseProductAsGift(this.var_1390,this.var_91,this.var_1391,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1390,this.var_91.offerId,this.var_1391);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_107:
               ...
               if(this.var_2272 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_226)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_2134)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2272 = _loc3_.text;
               break;
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowKeyboardEvent.const_313:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_350 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_350 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_350) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_246 == null || this.var_597 == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_350) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_350);
         }
         this.var_350 = param1;
         if(this.var_350 < 0)
         {
            this.var_350 = _loc2_.numListItems - 1;
         }
         if(this.var_350 >= _loc2_.numListItems)
         {
            this.var_350 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_350) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1375;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1892) : uint(this.const_1893);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1137;
               }
            }
            _loc4_++;
         }
