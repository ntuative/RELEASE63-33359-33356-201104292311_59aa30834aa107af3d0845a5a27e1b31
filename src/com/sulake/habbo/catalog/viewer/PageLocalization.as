package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1508:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      ...
      private static const const_168:Dictionary = new Dictionary();
      
      private static const const_1069:Object = {"frontpage3":[7,8]};
      
      private static const const_1070:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      
      {
         const_168["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_168["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_168["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_168["collectibles"] = ["ctlg_collectibles_link"];
         const_168["club1"] = ["ctlg_text_5"];
         const_168["club_buy"] = ["club_link"];
         const_168["mad_money"] = ["ctlg_madmoney_button"];
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_853.length)
         {
            _loc2_ = String(this.var_853[param1]).replace("#","0x");
