package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1016:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_279:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1016).style = HabboWindowStyle.const_29;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1016).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_85,MouseCursorType.const_791);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_791);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_41)
         {
            ...
            this.var_279.select(this);
            this.var_628 = param2;
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT && this.var_628 != null && this.var_628 == param2)
         {
            _loc3_ = this.var_279.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_628 = null;
            }
