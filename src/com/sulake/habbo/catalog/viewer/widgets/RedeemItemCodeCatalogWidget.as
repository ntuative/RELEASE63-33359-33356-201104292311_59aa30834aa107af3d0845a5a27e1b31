package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_989:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_989.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_989 = null;
         }
         if(this.var_990 != null)
         {
            this.var_990.removeEventListener(WindowKeyboardEvent.const_185,this.windowKeyEventProcessor);
            this.var_990 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_989 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_989 != null)
         {
            this.var_989.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_990 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_990 != null)
         {
            this.var_990.addEventListener(WindowKeyboardEvent.const_185,this.windowKeyEventProcessor);
         }
         return true;
      }
