package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2429:XML;
      
      private var var_2428:XML;
      
      private var var_2430:XML;
      
      private var var_937:IWindowContainer;
      
      private var var_605:IButtonWindow;
      
      private var var_2983:IButtonWindow;
      
      private var var_1785:ITextWindow;
      
      private var var_1786:ITextWindow;
      
      private var var_1787:ITextWindow;
      
      private var var_2949:ITextWindow;
      
      private var var_91:Offer;
      
      private var var_1784:String = "";
      
      private var var_1433:Function;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_836,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2429 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2428 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2430 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_836,this.onSetParameter);
      ...
      private function attachStub(param1:String) : void
      {
         ...
         switch(param1)
         {
            case Offer.const_901:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2429) as IWindowContainer;
               break;
            case Offer.const_1135:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2428) as IWindowContainer;
               break;
            case Offer.const_1207:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2430) as IWindowContainer;
               break;
            default:
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _window.removeChild(this.var_937);
         ...
         this.var_1785 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1786 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_1787 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_2949 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_605 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         if(this.var_605 != null)
         {
            if(this.var_1433 != null)
            {
               this.var_605.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1433);
            }
            else
            {
               this.var_605.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1433);
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1785 != null)
         {
            ...
            this.var_1785.caption = "${catalog.purchase.price.credits}";
         }
         var _loc3_:String = this.var_91.activityPointType == Purse.const_211 ? "pixels" : "activitypoints";
         if(this.var_1786 != null)
         {
            ...
            this.var_1786.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_1784 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(this.var_91 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_91,page.pageId,this.var_1784);
         }
      }
      ...
      private function initPurchase(param1:CatalogWidgetInitPurchaseEvent) : void
      {
         if(this.var_91 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_91,page.pageId,this.var_1784,param1.enableBuyAsGift);
         }
      }
   }
}
