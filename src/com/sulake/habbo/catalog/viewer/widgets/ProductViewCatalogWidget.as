package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1148:ITextWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_918 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1148 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1729 = new Point(this.var_83.x,this.var_83.y);
         ...
         this.var_1728 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_918.text = _loc4_;
         this.var_1148.text = _loc5_;
         this.var_918.height = this.var_918.textHeight + 5;
         this.var_1148.y = this.var_918.y + this.var_918.height;
         this.var_1148.height = Math.max(130,this.var_1148.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_582:
                  _loc6_ = this.var_1728.clone();
                  if(this.var_495 != null)
                  {
                     this.var_495.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_495,this.var_1406,this.var_1670);
                     ...
                     case ProductTypeEnum.const_219:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_303,AvatarAction.const_470);
                              _loc16_.appendAction(AvatarAction.const_357,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2337)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2337 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1729.x;
            this.var_83.y = this.var_1729.y;
            if(param3 != null)
            {
