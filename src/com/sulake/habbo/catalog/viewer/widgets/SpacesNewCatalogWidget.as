package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_408:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         super(param1);
         this.var_408 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_408)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_408.numSelectables)
            {
               _loc3_ = this.var_408.getSelectableAt(_loc2_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_101[this.var_535]);
      ...
      {
         var _loc2_:int = this.var_817[this.var_535];
         var _loc3_:Offer = this.var_207[this.var_535][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_576.numGridItems)
         {
            _loc2_ = this.var_207[this.var_535][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_817[this.var_535] = (this.var_207[this.var_535] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_817[0];
         var _loc2_:int = this.var_817[1];
         var _loc3_:int = this.var_817[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_412 || _loc1_.pricingModel == Offer.const_411))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_63 || _loc2_.productType == ProductTypeEnum.const_78))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_408.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_408.setSelected(this.var_408.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_207[this.var_535],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_817[this.var_535];
