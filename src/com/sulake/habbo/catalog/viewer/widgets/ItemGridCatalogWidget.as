package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_393:IGridItem;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_879,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_251,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_773,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_196,this.deActivateScrollbar);
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_576 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc2_ < 3)
         {
            if(this.var_846 >= 0 && this.var_846 < page.offers.length)
            {
               _loc3_ = page.offers[this.var_846];
               this.loadGraphics(_loc3_);
               _loc3_.productContainer.grid = this;
            }
            ++this.var_846;
            if(this.var_846 >= page.offers.length)
            {
               this.resetTimer();
               break;
            }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_582)
         {
            ++this.var_2051;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_2051);
         }
      }
