package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1833:String = "ctlg_";
       
      
      protected var var_1348:XML;
      ...
      private var var_553:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1295:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_553 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1294);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1294);
      }
      ...
      {
         var _loc2_:String = const_1833 + param1;
         ...
         this.var_1348 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1348) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1732:
               if(this.var_1295 == null)
               {
                  this.var_1295 = new ItemGridCatalogWidget(param1);
                  this.var_37.push(this.var_1295);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1630:
               ...
               break;
            case CatalogWidgetEnum.const_1770:
            ...
            case CatalogWidgetEnum.const_1589:
               ...
               break;
            case CatalogWidgetEnum.const_1715:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_553.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_553 != null)
         {
            return this.var_553.dispatchEvent(param1);
         }
         return false;
      }
