package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_2098:int = 1;
      
      public const const_1953:int = 2;
      
      public const const_2179:int = 3;
      ...
      private var var_2623:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_307);
            this.var_307 = null;
         }
         this._disposed = true;
      }
      ...
      {
         this.requestOffers(this.var_2628,this.var_2627,this.var_2625,this.var_2624);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_2098,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_307.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_307.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_538)
            {
               this.var_307.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2626 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_307.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1953,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_307.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2443 || param1.furniTypeId != this.var_2445)
         {
            return;
         }
