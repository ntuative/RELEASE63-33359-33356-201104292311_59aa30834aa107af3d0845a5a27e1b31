package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2999:String = "magic.credits";
      
      private var var_2970:String = "magic.pixels";
      
      private var var_2971:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2970);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2971,true);
      }
