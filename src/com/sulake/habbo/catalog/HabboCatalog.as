package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_676:uint = 1;
      ...
      private var var_1147:IRoomSession;
      ...
      private var var_191:CatalogViewer;
      ...
      private var var_315:ChargeConfirmationDialog;
      ...
      private var var_2765:Boolean = true;
      
      private var var_2017:Boolean = false;
      
      private var var_2764:GiftWrappingConfiguration;
      
      private var var_1278:ClubGiftController;
      
      private var var_550:ClubBuyController;
      
      private var var_838:Map;
      
      private var var_1277:Boolean = false;
      
      private var var_1032:IPurchasableOffer;
      
      private var var_1569:IDragAndDropDoneReceiver;
      
      private var var_65:PlacedObjectPurchaseData;
      
      private const const_984:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionEvent.const_94,this.onRoomSessionEvent);
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_550.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_388.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_177.getKey("client.credits.embed.enabled","WiredFurniTriggerMessageParser") == "true";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_421.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_421.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_63)
         {
            _loc3_ = this.var_421.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_838.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_106.getActivityPointsForType(Purse.const_211)));
         var _loc1_:int = 0;
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_763)
         {
            if(!this.var_421.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_191.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_388 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_191 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_191.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_676) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_984;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_255,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               this.var_2017 = param1.session.isPrivateRoom;
               this.var_1147 = param1.session;
               if(this.var_94 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1278 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_550 == null)
         {
            this.var_550 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_191 != null)
         {
            this.var_191.catalogWindowClosed();
         }
         if(this.var_94 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_94.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_388.buildCatalogIndex(_loc2_);
         if(this.var_839 && this.var_839 != "")
         {
            this.var_388.openPage(this.var_839);
            this.var_839 = "";
            this.var_1031 = -1;
         }
         else if(this.var_1031 > -1)
         {
            this.var_388.openPageById(this.var_1031,this.var_2016);
            this.var_1031 = -1;
            this.var_2016 = -1;
            this.var_839 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_191.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_191 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_191.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2765 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1169);
         }
         this.var_2765 = false;
         if(this.var_315 != null)
         {
         ...
         if(_loc2_.type == Purse.const_211)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1278.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_191.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_315 == null)
         {
            this.var_315 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_315.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_838.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_838.add(_loc2_.productCode,_loc3_.slice());
            this.var_191.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      {
         if(!this.var_177.keyExists("catalog.drag_and_drop") || this.var_177.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1147 || !this.var_1147.isRoomOwner)
         {
            return false;
         }
         ...
         {
            case ProductTypeEnum.const_219:
               _loc3_ = false;
               break;
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_208);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1277 && param1.type == RoomEngineObjectEvent.const_174)
         {
            ...
            _loc3_ = this.var_1032.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_1032);
            _loc5_ = this.var_1569;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_328,0.5);
            }
         }
      }
      ...
      public function resetPlacedOfferData(param1:Boolean = false) : void
      {
         ...
         if(this.var_65 != null)
         {
            if(this.var_65.category == RoomObjectCategoryEnum.const_26)
            {
               this._roomEngine.disposeObjectFurniture(this.var_65.roomId,this.var_65.roomCategory,this.var_65.objectId);
            }
            else if(this.var_65.category == RoomObjectCategoryEnum.const_25)
            {
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc2_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_199);
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_214);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_208);
         if(this.var_65 && this.var_65.productClassId == param1.classId)
         {
            if(this.var_65.roomCategory == this._roomEngine.activeRoomCategory && this.var_65.roomId == this._roomEngine.activeRoomId)
            {
               ...
               _loc6_ = this.var_65.category;
               _loc7_ = this.var_65.wallLocation;
               _loc8_ = this.var_65.x;
               _loc9_ = this.var_65.y;
               _loc10_ = this.var_65.direction;
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_177.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_676);
            if(_loc1_ != null)
            {
