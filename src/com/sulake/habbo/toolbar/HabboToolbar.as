package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_943 = this._config.getKey("client.toolbar.static.enabled","WiredFurniTriggerMessageParser") == "true";
         this.tryInitialize();
      }
      
      private function tryInitialize() : void
      {
         if(this.var_278 && this._windowManager && this._config)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","WiredFurniTriggerMessageParser") == "true")
         {
            this.var_1438 = new LogoutController(this,this._windowManager,this._assetLibrary,events,this._config);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_183,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_473,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1228,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1171,this.onHideWindowEvent);
         this._state = true;
      ...
      public function setNewItemCount(param1:String, param2:int) : void
      {
         if(this.var_943)
         {
            this._view.setNewItemCount(param1,param2);
         }
      }
   }
}
