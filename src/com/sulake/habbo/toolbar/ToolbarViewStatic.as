package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarViewStatic implements IToolbarView
   {
      ...
      private static const const_1435:uint = 7433577;
      
      private static const const_1434:uint = 5723213;
      
      private static const const_456:String = "_hover";
      
      private static const const_457:String = "_normal";
      ...
      public function ToolbarViewStatic(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         {
            this.setIconHoverState(_loc10_,const_457);
         }
         this.iconVisibility("QUESTS",false);
         this.iconVisibility("MEMENU",false);
         this.iconVisibility("INVENTORY",false);
         param5.addEventListener(HabboToolbarEvent.const_340,this.onToolbarStateEvent);
         param5.addEventListener(HabboToolbarEvent.const_305,this.onToolbarStateEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._events)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_340,this.onToolbarStateEvent);
            this._events.removeEventListener(HabboToolbarEvent.const_305,this.onToolbarStateEvent);
            this._events = null;
         }
      }
      ...
      private function onToolbarStateEvent(param1:HabboToolbarEvent) : void
      {
         switch(param1.type)
         {
            case HabboToolbarEvent.const_340:
               this.iconVisibility("QUESTS",false);
               this.iconVisibility("MEMENU",false);
               this.iconVisibility("INVENTORY",false);
               break;
            case HabboToolbarEvent.const_305:
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_456);
               this.setIconBgHoverState(_loc3_,const_456);
               break;
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT:
               this.setIconHoverState(_loc4_,const_457);
               this.setIconBgHoverState(_loc3_,const_457);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_456 ? this.var_1507 : this.var_1506;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_456)
         {
            param1.color = const_1435;
         }
         else
         {
            param1.color = const_1434;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1506 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1507)
         {
            this.var_1507.dispose();
         }
         this.var_1507 = this.addShadow(param1,new Point(4,5),4281150249);
      }
      ...
      public function setNewItemCount(param1:String, param2:int) : void
      {
         ...
         _loc4_.x = _loc5_.width - _loc4_.width - const_1040;
         _loc4_.y = const_1040;
      }
