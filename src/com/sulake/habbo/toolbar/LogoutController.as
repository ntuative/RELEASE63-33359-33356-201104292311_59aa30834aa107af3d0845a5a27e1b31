package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private static const const_1376:uint = 16777215;
      
      private static const const_1375:uint = 12247545;
      
      private static const const_1377:String = "HELP";
      
      private static const const_1374:String = "ROOMINFO";
      ...
      private const const_512:int = 44;
      ...
      public function LogoutController(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.hideRoomInfo();
         this.var_1814 = this._config.getKey("roominfo.widget.enabled") == "1";
         if(this.var_1814)
         {
            this._events.addEventListener(HabboToolbarEvent.const_305,this.onRoomView);
            this._events.addEventListener(HabboToolbarEvent.const_340,this.onHotelView);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_1814)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_305,this.onRoomView);
            this._events.removeEventListener(HabboToolbarEvent.const_340,this.onHotelView);
         }
         this._events = null;
         this._config = null;
         if(this._window)
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_592;
         _loc3_.y = this.const_512;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_613)
         {
            this.var_613 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1377);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1374);
               break;
            case "confirm":
               if(false)
               {
