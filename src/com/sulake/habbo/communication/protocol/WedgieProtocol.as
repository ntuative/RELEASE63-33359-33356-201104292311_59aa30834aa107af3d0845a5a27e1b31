package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1631:uint = 2;
       
      
      private var var_1581:IProtocolEncoder;
      
      private var var_1122:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1581 = new WedgieEncoder();
         this.var_1122 = new WedgieDecoder();
      }
      
      public function dispose() : void
      {
         this.var_1581.dispose();
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1552)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1122.getID(_loc4_);
