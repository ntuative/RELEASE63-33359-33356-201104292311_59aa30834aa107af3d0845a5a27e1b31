package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample
   {
      ...
      public static const const_1773:String = "sample_44khz";
      
      public static const const_1595:String = "sample_22khz";
      
      public static const const_1748:String = "sample_11khz";
      
      public static const const_1693:String = "sample_16bit";
      
      public static const const_1699:String = "sample_8bit";
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_170 * this.var_75;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            {
               this.var_142[int(_loc11_ / this.var_170)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_142.length * this.var_170 * this.var_75;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_170 * this.var_75;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         if(this.var_75 == 1)
         {
            if(this.var_170 == 2)
            {
               while(_loc6_-- > 0)
               {
                  ...
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = (_loc8_ >> 16 & const_191) - const_192;
                  var _loc12_:*;
                  param1[_loc12_ = param2++] = (_loc8_ & const_191) - const_192;
               }
            }
         ...
         else if(this.var_75 >= 2)
         {
            ...
            if(this.var_170 == 2)
            {
               ...
               {
                  _loc8_ = this.var_142[param4++];
                  _loc10_ = int((_loc8_ >> 16 & const_191) - const_192);
                  _loc9_ = this.var_75;
                  while(_loc9_ > 0)
                  {
                  ...
                  _loc10_ = int((_loc8_ & const_191) - const_192);
                  _loc9_ = this.var_75;
                  while(_loc9_ > 0)
                  {
                     param1[_loc11_ = param2++] = _loc10_;
      ...
      public function addSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         if(this.var_75 == 1)
         {
            if(this.var_170 == 2)
            {
               while(_loc6_-- > 0)
               {
                  ...
                  var _loc10_:*;
                  param1[_loc10_ = param2++] = param1[_loc10_] + ((_loc7_ >> 16 & const_191) - const_192);
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = param1[_loc11_] + ((_loc7_ & const_191) - const_192);
               }
            }
            else if(this.var_170 == 4)
            {
         ...
         else if(this.var_75 >= 2)
         {
            ...
            if(this.var_170 == 2)
            {
               ...
               {
                  _loc7_ = this.var_142[param4++];
                  _loc9_ = int((_loc7_ >> 16 & const_191) - const_192);
                  _loc8_ = this.var_75;
                  while(_loc8_ > 0)
                  {
                  ...
                  _loc9_ = int((_loc7_ & const_191) - const_192);
                  _loc8_ = this.var_75;
                  while(_loc8_ > 0)
                  {
                     param1[_loc10_ = param2++] = param1[_loc10_] + _loc9_;
