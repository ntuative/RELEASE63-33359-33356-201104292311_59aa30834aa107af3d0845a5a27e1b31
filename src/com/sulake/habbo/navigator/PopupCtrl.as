package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_436.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_436)
         {
            this.var_436.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_436.reset();
            this.var_436 = null;
         }
         if(this.var_363)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_56 == null)
         {
            this.var_56 = IWindowContainer(this._navigator.getXmlWindow(this.var_1081));
         ...
         this.var_56.x = _loc2_.x + this.var_2530 + param1.width;
