package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_316:MainViewCtrl;
      
      private var var_462:RoomInfoViewCtrl;
      
      private var var_1282:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_408:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2995:Dictionary;
      ...
      private var var_2313:RoomThumbnailRenderer;
      
      private var var_884:GuestRoomPasswordInput;
      
      private var var_302:GuestRoomDoorbell;
      
      private var var_1283:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_316 = new MainViewCtrl(this);
         this.var_462 = new RoomInfoViewCtrl(this);
         this.var_1282 = new RoomCreateViewCtrl(this);
         this.var_2313 = new RoomThumbnailRenderer(this);
         this.var_884 = new GuestRoomPasswordInput(this);
         this.var_302 = new GuestRoomDoorbell(this);
         this.var_408 = new Tabs(this);
         this.var_1283 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_322,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_462.registerToolbarEvents();
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_36)
         {
            ...
            {
               this.var_462.handleToolbarEvent(param1);
            }
      ...
      {
         var _loc1_:Boolean = this.var_316.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_316.startSearch(Tabs.const_267,Tabs.const_374,param1);
         this.var_316.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_316.startSearch(Tabs.const_344,Tabs.const_270);
         this.var_408.getTab(Tabs.const_344).tabPageDecorator.tabSelected();
      }
