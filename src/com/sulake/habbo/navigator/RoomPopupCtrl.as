package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2313 = new RoomThumbnailRenderer(param1);
         this.var_1248 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_179,this.var_112);
         if(this.var_112.ownerName != "" && this.var_112.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_179,!!this.var_112.event ? this.getEventCtg(this.var_112.categoryId) : this.getRoomCtg(this.var_112.categoryId));
         this.refreshRoomDesc(this.var_179,this.var_112);
         this.refreshExtraCont();
         this.refreshInfo(this.var_179,"trading_allowed",this.var_112.allowTrading);
         this.refreshInfo(this.var_179,"doormode_doorbell",this.var_112.doorMode == 1);
         this.refreshInfo(this.var_179,"doormode_password",this.var_112.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_179,this.var_112.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1248.refreshTags(_loc1_,this.var_112.tags);
         ...
         this.var_2313.refreshThumbnail(_loc1_,this.var_112.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_267,Tabs.const_240,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
