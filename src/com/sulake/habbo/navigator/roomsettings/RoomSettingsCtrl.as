package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_406:IRoomSettingsCtrlOwner;
      ...
      private var var_1093:TextFieldManager;
      ...
      private var var_1092:ICheckBoxWindow;
      
      private var var_1096:ICheckBoxWindow;
      
      private var var_1089:ICheckBoxWindow;
      
      private var var_582:ICheckBoxWindow;
      ...
      {
         this.var_335 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_335));
         if(this.var_1095 != null)
         {
            this.var_1095.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_335)
         {
            return;
         }
         this.var_72 = param1;
         this._active = true;
         this.var_1634 = true;
         this.var_406.roomSettingsRefreshNeeded();
      }
      
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         if(param1 != this.var_335)
         {
            return;
         }
      ...
      {
         if(param1 != this.var_335 || this.var_1090 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1090 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1654)
         {
            this.var_711.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1744)
         {
            this.var_711.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1573)
         {
            this.var_1093.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1790)
         {
            this.setTagError(this.var_883,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_885,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1674)
         {
            this.setTagError(this.var_883,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         ...
         {
            this.var_884.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_711.displayError("Update failed: error " + param2);
         }
      }
      ...
      {
         this.var_711.clearErrors();
         this.var_1093.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_331,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_617,this.onDoorModePasswordUnselect);
         ...
         this.var_711 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1093 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_883 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_885 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_884 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1094 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1092 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1096 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1089 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_582 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         ...
         this.var_1097 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1633 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1354 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_241 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1095 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1355 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1355.mouseThreshold = 0;
         this.var_1355.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1095.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1633.visible = this._inRoom;
         if(this.var_712)
         {
         ...
         this.var_1355.text = !!this.var_712 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1091.name,this.var_1097.name,this.var_1354.name,this.var_1633.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_711.setText(_loc1_.name);
         this.var_1093.setText(_loc1_.description);
         this.var_884.setText("");
         ...
         this.setTag(this.var_883,_loc1_.tags[0]);
         this.setTag(this.var_885,_loc1_.tags[1]);
         if(this.var_1092)
         {
            if(_loc1_.allowPets)
            {
               this.var_1092.select();
            }
            else
            {
               this.var_1092.unselect();
            }
         }
         if(this.var_1096)
         {
            ...
            {
               this.var_1096.select();
            }
            else
            {
               this.var_1096.unselect();
            }
         }
         if(this.var_1089)
         {
            ...
            {
               this.var_1089.select();
            }
            else
            {
               this.var_1089.unselect();
            }
         }
         if(this.var_582)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(this.var_72 == null || this._window == null || this._window.disposed)
         {
            return;
         }
         var _loc2_:SaveableRoomSettingsData = new SaveableRoomSettingsData();
         _loc2_.roomId = this.var_72.roomId;
         _loc2_.name = this.var_711.getText();
         _loc2_.description = this.var_1093.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_568;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_122)
         {
            _loc8_ = this.var_884.getText();
         ...
         _loc2_.allowPets = this.var_1092.isSelected;
         _loc2_.allowFoodConsume = this.var_1096.isSelected;
         _loc2_.allowWalkThrough = this.var_1089.isSelected;
         _loc2_.hideWalls = this.var_582.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_883,_loc2_.tags);
         this.addTag(this.var_885,_loc2_.tags);
         this.clearErrors();
         this.var_1090 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_335);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_72.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_335]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_183,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_74,HabboWindowStyle.const_29,HabboWindowParam.const_61,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_335));
      }
      ...
      private function onRemoveFlatCtrlClick(param1:WindowEvent) : void
      {
         ...
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_72.controllers)
         {
            if(_loc3_.selected)
            {
