package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2151:String = "my_issues";
      
      private const const_2153:String = "open_issues";
      
      private const const_2152:String = "picked_issues";
      
      private const const_2175:String = "closed_issues";
      ...
      private var var_358:IIssueBrowserView;
      
      private var var_1817:IIssueBrowserView;
      
      private var var_1816:IIssueBrowserView;
      
      private var var_1815:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_358 == _loc2_)
         {
            return;
         }
         if(this.var_358 != null)
         {
            this.var_358.visible = false;
         }
         this.var_358 = _loc2_;
         if(this.var_358 == null)
         {
         ...
         this.var_358.view.width = this.var_253.container.width;
         this.var_358.view.height = this.var_253.container.height;
         this.var_358.visible = true;
         this.var_358.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2151:
               ...
               {
                  this.var_1817 = new MyIssuesView(this.issueManager,this,this.var_253.container);
               }
               return this.var_1817;
            case this.const_2153:
               if(this.var_1816 == null)
               {
                  this.var_1816 = new OpenIssuesView(this.issueManager,this,this.var_253.container);
               }
               return this.var_1816;
            case this.const_2152:
               if(this.var_1815 == null)
               {
                  this.var_1815 = new PickedIssuesView(this.issueManager,this,this.var_253.container);
               }
