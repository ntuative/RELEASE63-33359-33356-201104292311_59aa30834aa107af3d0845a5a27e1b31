package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1001:Array = [];
      ...
      {
         this.var_822 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1597;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1001.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_822.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1001.length < var_1965)
         {
            ...
            param1.width = this.var_822.width;
            param1.height = this.var_822.height;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1536)
         {
