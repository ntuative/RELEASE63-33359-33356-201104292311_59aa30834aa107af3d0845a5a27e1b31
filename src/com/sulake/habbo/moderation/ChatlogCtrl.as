package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_932:Array = [];
      
      private static var var_1764:int = 1000;
      
      private static var var_933:Array = [];
      
      private static var var_1765:int = 200;
      ...
      {
         this.var_750 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_751 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         ...
         this.var_34.connection.send(this.var_1766);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_932.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_933.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_750.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_933.length < var_1765)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_750.width;
            param1.height = this.var_750.height;
            var_933.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1763[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1426.getValue(param2.chatterName))
            {
               this.var_1426.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1426.getValue(_loc2_);
      ...
      {
         if(param1.type != WindowEvent.const_37 || param2 != this._frame)
         {
            return;
         }
         this.var_521.reset();
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1424)
         {
