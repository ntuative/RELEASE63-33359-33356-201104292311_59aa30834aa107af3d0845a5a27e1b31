package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1749:int = 2;
      
      public static const const_1215:int = 3;
      
      public static const const_838:int = 4;
      
      public static const const_1300:int = 5;
      ...
      public static const const_1633:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_2014[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2014[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
