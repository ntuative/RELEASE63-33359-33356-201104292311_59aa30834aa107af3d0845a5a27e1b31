package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_861:Number = 64;
      
      public static const const_1289:Number = 32;
      ...
      private var var_1636:Number = 1.0;
      
      private var var_1637:Number = 1.0;
      
      private var var_89:Vector3d;
      
      private var var_413:Vector3d;
      
      private var var_2936:Number = -500.0;
      
      private var var_2937:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1637 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_411.assign(this.var_89);
         this.var_411.x *= this.var_412;
         this.var_411.y *= this.var_409;
         this.var_411.z *= this.var_410;
         return this.var_411;
      }
      ...
      {
         if(this.var_412 != param1 * this.var_1638)
         {
            this.var_412 = param1 * this.var_1638;
            ++this.var_151;
         }
      }
      ...
      {
         if(this.var_409 != param1 * this.var_1636)
         {
            this.var_409 = param1 * this.var_1636;
            ++this.var_151;
         }
      }
      ...
      {
         if(this.var_410 != param1 * this.var_1637)
         {
            this.var_410 = param1 * this.var_1637;
            ++this.var_151;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_89.x;
         var _loc3_:Number = this.var_89.y;
         var _loc4_:Number = this.var_89.z;
         this.var_89.assign(param1);
         this.var_89.x /= this.var_412;
         this.var_89.y /= this.var_409;
         this.var_89.z /= this.var_410;
         if(this.var_89.x != _loc2_ || this.var_89.y != _loc3_ || this.var_89.z != _loc4_)
         {
            ++this.var_151;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_413.x;
         var _loc3_:Number = this.var_413.y;
         var _loc4_:Number = this.var_413.z;
         this.var_413.assign(param1);
         this._direction.assign(param1);
         if(this.var_413.x != _loc2_ || this.var_413.y != _loc3_ || this.var_413.z != _loc4_)
         {
            ++this.var_151;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1100.assign(this.var_154);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_481 != null)
         {
            ...
            this.var_481.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_481.add(_loc3_,_loc4_);
            ++this.var_151;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_481 != null)
         {
            ...
            return this.var_481.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1099.assign(_loc22_);
         }
         else
         {
            this.var_1099.assign(_loc17_);
         }
         ++this.var_151;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_89);
         _loc2_.x *= this.var_412;
         _loc2_.y *= this.var_409;
         _loc2_.z *= this.var_410;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1099);
         if(_loc3_ < this.var_2936 || _loc3_ > this.var_2937)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_89);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_412;
            _loc2_.y *= this.var_409;
            _loc2_.z *= this.var_410;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1099);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_153,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_89.x * this.var_412,this.var_89.y * this.var_409,this.var_89.z * this.var_410);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_154;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_412,param2.y * this.var_409,param2.z * this.var_410);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_412,param3.y * this.var_409,param3.z * this.var_410);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_412,param4.y * this.var_409,param4.z * this.var_410);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1289;
         }
         else
         {
            this.scale = const_861;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_861;
      }
