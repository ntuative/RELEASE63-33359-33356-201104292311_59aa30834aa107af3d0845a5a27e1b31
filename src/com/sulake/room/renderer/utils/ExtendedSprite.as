package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1639 || param2 != this.var_1640)
         {
      ...
      {
         if(this.var_1359 > 255 || bitmapData == null)
         {
            return false;
         }
