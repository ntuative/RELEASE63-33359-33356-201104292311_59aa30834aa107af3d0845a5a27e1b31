package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1427:int = 50;
      
      private static const const_1031:Number = 60;
      
      private static const const_1426:Number = 50;
      ...
      private var var_258:BitmapDataCache;
      ...
      private var var_1487:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2569:Number = -1.0E7;
      ...
      private var var_1885:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_258 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
      ...
      {
         this.var_527.x -= param1 - this.var_635;
         this.var_635 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_527.y -= param1 - this.var_633;
         this.var_633 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_888 = true;
            if(this.var_135 != null && !this.var_257.contains(this.var_135))
            {
               this.var_257.addChild(this.var_135);
               this.var_100.mask = this.var_135;
            }
         }
         else if(!param1 && this.var_888)
         {
            this.var_888 = false;
            if(this.var_135 != null && this.var_257.contains(this.var_135))
            {
               this.var_257.removeChild(this.var_135);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_257.numChildren > 0)
            {
               this.var_257.removeChildAt(0);
            }
            this.var_257 = null;
         }
         this.var_100 = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_525 != this.var_2571 || this.var_528 != this.var_2572)
         {
            _loc8_ = true;
         }
         if(this.var_100.x != this.var_635 || this.var_100.y != this.var_633)
         {
            this.var_100.x = this.var_635;
            this.var_100.y = this.var_633;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2571 = this.var_525;
         this.var_2572 = this.var_528;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1488 > 0)
         {
            ...
            {
               ++this.var_792;
               if(this.var_792 == const_365 + 1)
               {
                  this.var_493 = _loc2_;
                  this.var_1885 = this.var_2573;
               }
               else if(this.var_792 > const_365 + 1)
               {
                  _loc3_ = Number(this.var_792 - const_365);
                  this.var_493 = this.var_493 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1885 = this.var_1885 * (_loc3_ - 1) / _loc3_ + Number(this.var_2573) / _loc3_;
                  if(this.var_792 > const_365 + const_1427)
                  {
                     this.var_792 = const_365;
                     if(!this.var_1209 && this.var_493 > const_1031)
                     {
                        this.var_1209 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1209 && this.var_493 < const_1426)
                     {
                        this.var_1209 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1886 && this.var_1209);
      ...
      {
         if(param1 < this.var_525 && param1 + param3 >= 0 && (param2 < this.var_528 && param2 + param4 >= 0))
         {
            if(!this.var_2956)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_525)
         {
            param3 -= this.var_525 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_528)
         {
            param4 -= this.var_528 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2567)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_975)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= this.var_975)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_791 || this.var_791 == 0)
         {
            _loc4_ = this.var_975 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_258.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_258.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_258.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_636.identity();
            if(flipH)
            {
               this.var_636.scale(-1,1);
               this.var_636.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_636.scale(1,-1);
               this.var_636.translate(0,data.height);
            }
            finalData.draw(data,this.var_636);
            if(name.length > 0)
            {
               this.var_258.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_648);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_805.redMultiplier = tR;
            this.var_805.greenMultiplier = tG;
            this.var_805.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_805);
            if(name.length > 0)
            {
               this.var_258.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1210 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1887;
         }
         this.var_1887 = this.method_8(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1210;
         return this.var_1887;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_525 / 2;
      ...
      private function method_8(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2568 || param2 != this.var_2569)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         while(_loc1_ < this.var_369.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1487.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1210 == 0)
         {
            this.method_8(this.var_527.x,this.var_527.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1210 = 0;
         ++this.var_1888;
      }
