package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_379:IRoomObject;
      
      private var var_829:IGraphicAssetCollection;
      
      protected var var_479:int = -1;
      
      protected var var_174:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_211 != null)
         {
            ...
            {
               _loc1_ = this.var_211[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_829.removeReference();
         }
         this.var_829 = param1;
         if(this.var_829 != null)
         {
            this.var_829.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_211.length > param1)
         {
            _loc2_ = this.var_211[this.var_211.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         this.var_479 = 4294967295;
         this.var_174 = 4294967295;
         this.var_88 = -1;
      }
