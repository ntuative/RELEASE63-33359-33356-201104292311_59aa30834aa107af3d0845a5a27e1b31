package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_296:String = "uint";
      
      public static const const_131:String = "Number";
      
      public static const const_1669:String = "float";
      
      public static const const_40:String = "Boolean";
      
      public static const const_1800:String = "bool";
      ...
      private static const const_650:String = "key";
      ...
      private static const const_1851:String = "WiredFurniTriggerMessageParser";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_650));
         }
         else
         {
            _loc4_ = param1.child(const_650)[0];
         }
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1669:
               return Number(param1);
            case const_40:
               return param1 == const_662 || int(param1) > 0;
            case const_1800:
               return param1 == const_662 || int(param1) > 0;
            case const_165:
               return uint(param1);
