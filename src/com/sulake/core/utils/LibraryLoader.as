package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1834:uint = 1;
      
      protected static const const_1837:uint = 2;
      
      protected static const const_1836:uint = 4;
      
      protected static const const_1835:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1671:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1294:Boolean = false;
      
      public static const const_1672:int = 2;
      
      private static var var_1055:Array = new Array();
      ...
      protected var var_685:Class;
      
      protected var var_480:uint = 0;
      
      protected var _name:String;
      
      protected var var_1087:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1086:Boolean = false;
      
      protected var var_2934:String = "";
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1294)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_850[_loc2_] as LibraryLoader;
            ...
            while(var_850.length < const_1672 && false)
            {
               _loc1_ = var_1055.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1087 ? uint(this.var_1350 - this.var_2147) : uint(getTimer() - this.var_2147);
      }
      ...
      {
         if(this.var_1086 && !_disposed)
         {
            this.var_1086 = false;
            if(!this.var_1087 && this.var_240)
            {
               this.var_1350 = -1;
               this.var_2147 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1087 && !_disposed && this.var_1351 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_240,const_1671 - this.var_1351);
            if(this.var_2933)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_480 = LibraryLoader.name_4;
         ...
         if(this.var_480 == LibraryLoader.const_1835)
         {
         ...
         if(this.var_480 == LibraryLoader.name_4)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_685 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_685.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
