package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         return this.var_1018[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2725);
      }
      ...
      public function loadLocalizationFromURL(param1:String) : void
      {
         ...
         _loc4_.addEventListener(AssetLoaderEvent.const_47,this.onLocalizationFailed);
      }
      ...
      {
         var _loc3_:Localization = this.var_58[param1] as Localization;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:Localization = this.var_58[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Localization(param1,param2);
            this.var_58[param1] = _loc3_;
         }
         else
         {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_1995);
         }
      }
      ...
      {
         var _loc5_:Localization = this.var_58[param1];
         if(_loc5_ == null)
         {
            _loc5_ = new Localization(param1);
            this.var_58[param1] = _loc5_;
         }
      ...
      {
         return this.var_58[param1] as ILocalization;
      }
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_58)
         {
            ...
            {
               _loc2_.registerParameter("predefined",this.var_1995);
            }
         }
      }
   }
