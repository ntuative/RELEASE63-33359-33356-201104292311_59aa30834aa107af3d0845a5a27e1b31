package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_102:String = "ChargeOffer";
      
      public static const const_109:String = "active";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_399 = SkinLayoutEntity.const_467;
                  break;
               case "move":
                  _loc5_.var_399 = SkinLayoutEntity.const_348;
                  break;
               case "strech":
                  _loc5_.var_399 = SkinLayoutEntity.const_601;
                  break;
               case "tiled":
                  _loc5_.var_399 = SkinLayoutEntity.const_330;
                  break;
               case "center":
                  _loc5_.var_399 = SkinLayoutEntity.const_1281;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_398 = SkinLayoutEntity.const_467;
                  break;
               case "move":
                  _loc5_.var_398 = SkinLayoutEntity.const_348;
                  break;
               case "strech":
                  _loc5_.var_398 = SkinLayoutEntity.const_601;
                  break;
               case "tiled":
                  _loc5_.var_398 = SkinLayoutEntity.const_330;
                  break;
               case "center":
                  _loc5_.var_398 = SkinLayoutEntity.const_1281;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_109:
               _loc10_ = 0;
               break;
