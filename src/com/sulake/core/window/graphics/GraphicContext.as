package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1568:uint = 0;
      
      public static const const_782:uint = 1;
      
      public static const const_1206:uint = 2;
      
      public static const const_772:uint = 4;
      
      public static const const_1677:uint = 8;
      
      public static const const_1626:uint = 16;
      
      public static const const_1936:uint = 64;
      
      public static const const_2002:uint = 128;
      
      public static const const_1133:uint = 256;
      
      protected static var var_579:uint = 0;
      
      protected static var var_331:uint = 0;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1206:
               ...
               break;
            case GraphicContext.const_1677:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1626:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_772:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1133:
               break;
            case GraphicContext.const_1568:
               break;
            default:
         ...
         if(this.var_875)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_331 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2133,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2133,16777215);
                  }
                  var_331 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_875)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_331 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
