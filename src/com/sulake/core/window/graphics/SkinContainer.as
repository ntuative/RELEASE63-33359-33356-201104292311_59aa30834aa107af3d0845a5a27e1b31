package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1497:String = "skin";
      
      private static const const_1501:String = "bitmap";
      
      private static const const_1499:String = "fill";
      
      private static const const_1496:String = "text";
      
      private static const const_1500:String = "label";
      
      private static const const_1498:String = "shape";
      ...
      private var var_2799:Dictionary;
      
      private var var_2800:Dictionary;
      
      private var var_2801:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_2037,this.var_2799);
         this.var_2800 = new Dictionary();
         this.var_2801 = new Dictionary();
         StateCodeTable.fillTables(this.var_2800,this.var_2801);
         this.var_465 = new Dictionary();
         this.var_465[const_1497] = BitmapSkinRenderer;
         this.var_465[const_1501] = BitmapDataRenderer;
         this.var_465[const_1499] = FillSkinRenderer;
         this.var_465[const_1496] = TextSkinRenderer;
         this.var_465[const_1500] = LabelRenderer;
         this.var_465[const_1498] = ShapeSkinRenderer;
         this.var_465[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_465[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_333 == null)
         {
            var_333 = new Array();
            var_333.push(WindowState.const_68);
            var_333.push(WindowState.const_86);
            var_333.push(WindowState.const_92);
            var_333.push(WindowState.const_54);
            var_333.push(WindowState.const_85);
            var_333.push(WindowState.const_88);
            var_333.push(WindowState.const_109);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2911 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2037[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1042[param1] == null)
         {
            this.var_1042[param1] = new Array(const_1058);
         }
         this.var_1042[param1][param2] = param3;
         if(this.var_1041[param1] == null)
         {
            this.var_1041[param1] = new Array(const_1058);
         }
         this.var_1041[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1042[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1041[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_179)
