package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1271:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1315:String = "_COLORIZE";
      
      protected static const const_1314:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1051:Point = new Point();
      ...
      protected var var_710:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_400 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_61 = var_400.clone();
            var_11 = var_400.clone();
         ...
         if(_loc13_)
         {
            var_860 = _loc13_.blend;
            var_473 = _loc13_.var_2911;
            if(var_472 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_238 != _loc13_.color)
            {
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  _loc12_ = param1.testParamFlag(WindowParam.const_108);
                  if(_loc12_)
                  {
                     param1.setParamFlag(WindowParam.const_108,false);
                  }
                  param1.offset(-_loc4_,-_loc5_);
                  if(_loc12_)
                  {
                     param1.setParamFlag(WindowParam.const_108,true);
                  }
                  _loc3_++;
               }
            }
      ...
      {
         return this.var_710 != null ? this.var_710 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_472 = param1;
         var_238 = !!var_472 ? uint(var_238 | var_569) : uint(var_238 & 16777215);
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_238 = !!var_472 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_59);
      }
      ...
      {
         var_569 = param1 << 24;
         var_238 = !!var_472 ? uint(var_569 | var_238) : uint(16777215 & var_238);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_59);
      }
      
      public function set blend(param1:Number) : void
      {
         var_860 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      {
         var_473 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_753);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_77)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1314) == -1)
               {
                  _loc4_.style = var_77;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_609,this,this._parent);
            ...
            else
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1556,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_782,var_11);
            this.var_21.visible = var_303;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_77,var_19,_context,var_11,null,this.var_710,this.properties,var_872.concat(),_id) as WindowController;
         _loc2_.var_473 = var_473;
         _loc2_.var_175 = this.var_175;
         _loc2_._debug = this._debug;
         _loc2_.var_385 = this.var_385.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_400 = var_400.clone();
         ...
         _loc2_.var_238 = var_238;
         _loc2_.var_569 = var_569;
         _loc2_.var_702 = var_702;
         _loc2_.var_303 = var_303;
         _loc2_.var_860 = var_860;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2744 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_540)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_628)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(testParamFlag(WindowParam.const_108))
         {
            if(this._parent != null)
            {
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1261,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_236,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_37,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
         }
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = 0;
         if(!testParamFlag(WindowParam.const_941))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_41:
                  ...
                  _loc4_.begin(this);
                  _loc4_.eventTypes.push(WindowMouseEvent.const_51);
                  _loc4_.areaLimit = MouseListenerType.const_1267;
                  ...
                  if((var_19 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_339))
                        {
               ...
               case WindowMouseEvent.const_51:
                  ...
                  if(testParamFlag(WindowParam.const_339))
                  {
               ...
               case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                  ...
                  break;
               case WindowMouseEvent.const_301:
                  return false;
            }
         }
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_37:
                  _context.invalidate(this,var_11.union(var_61),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_712,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_198,WindowParam.const_181))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_217,WindowParam.const_178))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc6_ = uint(var_19);
                        var_19 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_624))
                        {
               ...
               case WindowEvent.const_236:
                  _context.invalidate(this,var_11.union(var_61),WindowRedrawFlag.const_1148);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1537,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_205,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_496:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1260,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_312,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_473);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_473);
      }
         ...
         if(this.var_175 && var_473 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1051,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1051,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_77 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1314) == -1)
               {
                  _loc6_.style = var_77;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_141,WindowParam.const_181);
         var _loc2_:* = !testParamFlag(WindowParam.const_160,WindowParam.const_178);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_436)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_381)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               _loc5_ = uint(var_19 & 0);
               if(_loc5_ == WindowParam.const_352)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_265)
               {
                  _loc3_.y += _loc4_;
               }
         ...
         else if(testParamFlag(WindowParam.const_108))
         {
            _loc3_ = var_11.clone();
            if(this._parent != null)
            {
      ...
      {
         if(_state == WindowState.const_604)
         {
            return true;
         }
         _state = WindowState.const_604;
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1627,this,null);
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1791,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1806,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1717,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1809,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1593,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1692,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_549,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1637,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_68,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1799,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_68,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1793,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_879,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_251,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_773,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_196,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_318,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1559,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1689,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function method_10(param1:Point, param2:Array, param3:uint = 0) : void
      {
         var _loc4_:* = null;
         if(var_303)
         {
            if(var_11.containsPoint(param1))
            {
               ...
               {
                  _loc4_.method_10(param1,param2,param3);
               }
               param1.offset(var_11.x,var_11.y);
            }
            else if(!var_702)
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_498,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_498,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
