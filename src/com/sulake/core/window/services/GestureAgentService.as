package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_1375:uint = 0;
      
      protected var var_286:Function;
      
      protected var var_1339:int;
      
      protected var var_1338:int;
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1339 *= 0.75;
         this.var_1338 *= 0.75;
         if(Math.abs(this.var_1339) <= 1 && Math.abs(this.var_1338) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_286 != null)
         {
            this.var_286(this.var_1339,this.var_1338);
         }
      }
