package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2131:Boolean = false;
      ...
      protected var var_1079:Boolean = true;
      
      protected var var_474:Boolean = false;
      
      protected var var_1335:Boolean = false;
      
      protected var var_2132:int = 0;
      
      protected var var_2130:int = 0;
      
      protected var var_1336:Number;
      
      protected var var_1337:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_108 = 0;
         this.var_95 = 0;
         this._horizontal = param2 == WindowType.const_441;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_175 = var_472 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_432,WindowStyle.const_179,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_37,this.containerEventHandler);
         ...
         this._container.addEventListener(WindowEvent.const_205,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1335;
      }
      ...
      {
         return new Rectangle(this.var_704 * this.maxScrollH,this.var_706 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_704)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_466,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_624,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_626,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_37,this.containerEventHandler);
            ...
            this._container.removeEventListener(WindowEvent.const_205,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_41:
               this.var_2132 = _loc3_;
               this.var_2130 = _loc4_;
               this.var_1336 = 0;
               this.var_1337 = 0;
               this.var_1334 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_197:
               if(this.var_1334)
               {
                  this.var_1336 = this.var_2132 - _loc3_;
                  this.var_1337 = this.var_2130 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1336 != 0 && this.var_108 != 0)
                     {
                        this.scrollH += this.var_1336 / this.var_108;
                     }
                  }
                  else if(this.var_1337 != 0 && this.var_95 != 0)
                  {
                     this.scrollV += this.var_1337 / this.var_95;
                  }
                  this.var_2132 = _loc3_;
                  this.var_2130 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_207:
               if(this.var_1334)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1336,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1337);
                  }
                  this.var_1334 = false;
                  _loc2_ = true;
               }
      ...
      private function containerEventHandler(param1:WindowEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowEvent.const_205:
               ...
               break;
            case WindowEvent.const_37:
               _loc2_ = WindowEvent.allocate(WindowEvent.const_37,this,null);
               _events.dispatchEvent(_loc2_);
               _loc2_.recycle();
               break;
            default:
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1079 && !this.var_572 && this._container)
         {
            this.var_572 = true;
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(PropertyDefaults.const_1273);
         }
         if(this.var_1079 != PropertyDefaults.const_1305)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_916,this.var_1079,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1553);
         }
         if(this.var_474 != PropertyDefaults.const_1181)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_837,this.var_474,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1795);
         }
         if(this.var_1335 != PropertyDefaults.const_1222)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_933,this.var_1335,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1582);
         }
         if(this.var_703 != PropertyDefaults.const_1309)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_689,this.var_703,PropertyStruct.const_131,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1727);
         }
         if(this.var_705 != PropertyDefaults.const_1150)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_702,this.var_705,PropertyStruct.const_131,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1729);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_916:
                  this.var_1079 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_689:
