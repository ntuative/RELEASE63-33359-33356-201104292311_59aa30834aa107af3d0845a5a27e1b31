package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1331:String = "_SELECTOR";
      
      private static const const_1330:String = "_CONTENT";
       
      
      protected var var_1077:ITabSelectorWindow;
      
      protected var var_2129:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1077 = findChildByTag(const_1331) as ITabSelectorWindow;
            if(this.var_1077 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2129 = findChildByTag(const_1330) as IWindowContainer;
         }
      ...
      {
         return !!this.var_763 ? this.selector.iterator : null;
      }
