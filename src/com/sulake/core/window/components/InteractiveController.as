package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_623)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_197)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_623)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_761,param1.toolTipCaption,PropertyStruct.const_55,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1557);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1131)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_965,param1.toolTipDelay,PropertyStruct.const_296,true));
         }
         else
         {
      ...
      {
         this.var_1331 = param1 == null ? "null" : param1;
      }
