package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1619:uint = 500;
      
      protected var var_1331:String = "";
      
      protected var var_1346:Boolean = false;
      
      protected var var_763:Boolean = false;
      ...
      {
         this.var_1331 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1206,var_11);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_763 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         if(!_loc2_ && !param1)
         {
            _loc3_ = WindowEvent.allocate(WindowEvent.const_37,this,null);
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_404,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_313,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_107,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_738,false,PropertyStruct.const_40,true) : PropertyDefaults.const_1711);
         _loc1_.push(this.var_1346 != PropertyDefaults.const_1178 ? new PropertyStruct(PropertyDefaults.const_798,this.var_1346,PropertyStruct.const_40,true) : PropertyDefaults.const_1563);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1218 ? new PropertyStruct(PropertyDefaults.const_936,_field.selectable,PropertyStruct.const_40,true) : PropertyDefaults.const_1549);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1250 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_40,true) : PropertyDefaults.const_1632);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_798:
                  this.var_1346 = _loc2_.value as Boolean;
                  if(this.var_1346)
                  {
               ...
               case PropertyDefaults.const_738:
                  ...
                  break;
               case PropertyDefaults.const_1277:
