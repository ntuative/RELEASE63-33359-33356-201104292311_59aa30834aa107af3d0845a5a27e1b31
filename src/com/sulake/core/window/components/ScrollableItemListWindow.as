package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1265:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_453)
         {
            this.var_453.removeEventListener(WindowEvent.const_251,this.scrollBarEventProc);
            this.var_453.removeEventListener(WindowEvent.const_196,this.scrollBarEventProc);
            this.var_453 = null;
         }
         if(this.var_1265)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1265)
         {
            this.var_1265 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_453)
         {
            ...
            if(this.var_453)
            {
               this.var_453.addEventListener(WindowEvent.const_251,this.scrollBarEventProc);
               this.var_453.addEventListener(WindowEvent.const_196,this.scrollBarEventProc);
            }
         }
         return this.var_453;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_196)
         {
            this.hideScrollBar();
         }
      }
