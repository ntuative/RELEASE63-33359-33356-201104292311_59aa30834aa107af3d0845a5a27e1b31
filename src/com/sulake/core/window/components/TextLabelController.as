   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_392);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2816 = _loc2_.textWidth;
         this.var_2815 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_392 != _loc2_.color : this.var_392 != null && this.var_392 != PropertyDefaults.const_922) ? new PropertyStruct(PropertyDefaults.const_419,this.var_392,PropertyStruct.const_165,true) : PropertyDefaults.const_1205);
         if(this.var_41)
         {
            if(this.var_41.left != PropertyDefaults.const_844)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_281,this.var_41.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_489);
            }
            if(this.var_41.top != PropertyDefaults.const_767)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,this.var_41.top,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_512);
            }
            if(this.var_41.right != PropertyDefaults.const_900)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_285,this.var_41.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_592);
            }
            if(this.var_41.bottom != PropertyDefaults.const_880)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_286,this.var_41.bottom,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_571);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_419:
                  this.var_392 = _loc2_.value as uint;
                  break;
