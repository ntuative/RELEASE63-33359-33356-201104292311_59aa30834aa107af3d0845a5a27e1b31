package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1392:String = "_TITLE";
      
      private static const const_1391:String = "_HEADER";
      
      private static const const_1389:String = "_CONTENT";
      
      private static const const_1390:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1456:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1392) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1456 = findChildByTag(const_1391) as IHeaderWindow;
            if(!this.var_1456)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_194 = findChildByTag(const_1389) as IWindowContainer;
            if(!this.var_194)
            {
      ...
      {
         return findChildByTag(const_1390) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1315,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1087 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_339);
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_354,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_281,_loc3_.left,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,_loc3_.top,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_285,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_286,0 - _loc3_.bottom,PropertyStruct.const_42,_loc2_));
         }
         else
         {
