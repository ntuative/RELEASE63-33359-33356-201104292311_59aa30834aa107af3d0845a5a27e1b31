package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1368:String = "increment";
      
      private static const const_1369:String = "decrement";
      
      private static const const_1000:String = "slider_track";
      
      private static const const_654:String = "slider_bar";
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_17.removeEventListener(WindowEvent.const_37,this.onScrollableResized);
            this.var_17.removeEventListener(WindowEvent.const_466,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_37,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_466,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_935 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1000) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_654) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_654:
               if(param2.type == WindowEvent.const_205)
               {
                  if(!this.var_1168)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowEvent.const_609)
         {
            if(this.var_17 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_301)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_751)
         {
            if(param2.name == const_1368)
            {
               if(this.var_17)
               {
                  this.var_1168 = true;
            ...
            else if(param2.name == const_1369)
            {
               if(this.var_17)
               {
                  this.var_1168 = true;
            ...
            else if(param2.name == const_1000)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_654).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_301)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_935) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_935) as IScrollableWindow;
               if(_loc1_)
               {
