package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1033:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_2019:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1280 == param2)
         {
            return;
         }
         param1.var_1280 = param2;
         param1.var_2019 = null;
         if(param1.var_1280 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1280);
            param1.var_2019 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_748.indexOf(param1) > -1)
         {
            this.var_840 = param1;
         }
      }
      ...
      {
         return this.var_840 == LinkTarget.const_29 ? defaultLinkTarget : this.var_840;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_2019;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1196)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_831,this.var_840,PropertyStruct.const_55,true,PropertyDefaults.const_748));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_831)
            {
