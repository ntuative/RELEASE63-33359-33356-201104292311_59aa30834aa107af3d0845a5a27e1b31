package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1312:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_874:Number;
      ...
      protected var var_125:Boolean = false;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_204);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_946 ? true : null;
         }
      ...
      {
         this.var_874 = param1;
         this._field.scrollH = this.var_874 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_874 * this.maxScrollH,this.var_571 * this.maxScrollV,width,height);
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         if(!this.var_570)
         {
            if(param2.type == WindowEvent.const_37)
            {
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         if(!_loc7_ && !param1)
         {
            _loc8_ = WindowEvent.allocate(WindowEvent.const_37,this,null);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("always_show_selection",this._field.alwaysShowSelection,PropertyStruct.const_40,this._field.alwaysShowSelection != false));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_923,this._field.antiAliasType,PropertyStruct.const_55,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1278));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1243 ? new PropertyStruct(PropertyDefaults.const_722,this._autoSize,PropertyStruct.const_55,true,PropertyDefaults.const_1234) : PropertyDefaults.const_1572);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_40,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_165,this._field.borderColor != 0));
         _loc1_.push(new PropertyStruct("condense_white",this._field.condenseWhite,PropertyStruct.const_40,this._field.condenseWhite != false));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_296,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1093 ? new PropertyStruct(PropertyDefaults.const_1088,this._field.gridFitType,PropertyStruct.const_55,true,PropertyDefaults.const_1121) : PropertyDefaults.const_1646);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_922) ? new PropertyStruct(PropertyDefaults.const_419,this._field.textColor,PropertyStruct.const_165,true) : PropertyDefaults.const_1205);
         _loc1_.push(this.var_420 != TextStyleManager.const_204 ? new PropertyStruct(PropertyDefaults.const_423,this.var_420,PropertyStruct.const_55,true,PropertyDefaults.const_830) : PropertyDefaults.const_1111);
         _loc1_.push(this.var_41.left != PropertyDefaults.const_844 ? new PropertyStruct(PropertyDefaults.const_281,this.var_41.left,PropertyStruct.const_42,true) : PropertyDefaults.const_489);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_767 ? new PropertyStruct(PropertyDefaults.const_246,this.var_41.top,PropertyStruct.const_42,true) : PropertyDefaults.const_512);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_900 ? new PropertyStruct(PropertyDefaults.const_285,this.var_41.right,PropertyStruct.const_42,true) : PropertyDefaults.const_592);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_880 ? new PropertyStruct(PropertyDefaults.const_286,this.var_41.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_571);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1275 ? new PropertyStruct(PropertyDefaults.const_816,this._field.mouseWheelEnabled,PropertyStruct.const_40,true) : PropertyDefaults.const_1619);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_42,this._field.maxChars != 0));
         _loc1_.push(new PropertyStruct("multiline",this._field.multiline,PropertyStruct.const_40,this._field.multiline != false));
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_55,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_131,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_131,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_40,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("bold",this._field.defaultTextFormat.bold != false,PropertyStruct.const_40,this._field.defaultTextFormat.bold != false && _loc2_.fontWeight != FontStyle.BOLD));
         _loc1_.push(new PropertyStruct("italic",this._field.defaultTextFormat.italic != false,PropertyStruct.const_40,this._field.defaultTextFormat.italic != false && _loc2_.fontStyle != FontStyle.ITALIC));
         _loc1_.push(new PropertyStruct("underline",this._field.defaultTextFormat.underline != false,PropertyStruct.const_40,this._field.defaultTextFormat.underline != false && _loc2_.textDecoration != "underline"));
         _loc1_.push(new PropertyStruct("kerning",this._field.defaultTextFormat.kerning != false,PropertyStruct.const_40,this._field.defaultTextFormat.kerning != false && !_loc2_.kerning));
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_131,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
