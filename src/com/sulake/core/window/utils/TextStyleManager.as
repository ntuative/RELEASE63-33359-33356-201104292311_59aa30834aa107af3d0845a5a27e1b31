package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_204:String = "regular";
      ...
      private static var var_510:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_657:String = "{";
      
      private static const const_656:String = "}";
      
      private static const const_1373:String = "/*";
      
      private static const const_1372:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_84[const_204],var_84[ITALIC],var_84[BOLD]];
            var_84.reset();
            var_84[const_204] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_510.indexOf(_loc4_.name) == -1)
            {
               var_510.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_656);
         if(countSubStrings(param1,const_657) != countSubStrings(param1,const_656))
         {
            throw new Error("Mismatching amount of \"" + const_657 + "\" versus \"" + const_656 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1373) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1372) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_657)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
