package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2959 = param3 == const_239 || param3 == const_143 || param3 == const_271 || param3 == const_256;
         this.var_2665 = param5;
      }
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_40:
               return Boolean(this.var_186) == true ? "true" : "WiredFurniTriggerMessageParser";
            case const_271:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_256:
               ...
               break;
            case const_165:
               _loc1_ = "<var key=\"" + this.var_656 + "\" value=\"" + "0x" + uint(this.var_186).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_656 + "\" value=\"" + this.var_186 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
