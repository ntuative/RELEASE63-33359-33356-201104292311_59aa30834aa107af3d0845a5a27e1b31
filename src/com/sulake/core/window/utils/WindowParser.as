package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1197:String = "_EXCLUDE";
      
      public static const const_2003:String = "_INCLUDE";
      
      public static const const_2092:String = "_TEMP";
      
      private static const const_1399:String = "layout";
      
      private static const const_1011:String = "window";
      
      private static const const_1013:String = "variables";
      
      private static const const_1012:String = "filters";
      
      private static const const_451:String = "name";
      
      private static const const_1395:String = "style";
      
      private static const const_661:String = "params";
      
      private static const const_1402:String = "tags";
      ...
      private static const const_1398:String = "visible";
      ...
      private static const const_1233:String = "blend";
      
      private static const const_1404:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1403:String = "treshold";
      
      private static const const_1397:String = "children";
      
      private static const const_1406:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1396:String = "height_min";
      
      private static const const_1394:String = "height_max";
      
      private static const const_662:String = "true";
      
      private static const const_177:String = "0";
      
      private static const const_1407:String = "$";
      
      private static const const_1339:String = ",";
      
      private static const const_49:String = "";
      
      private static const const_1401:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1400:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1342:Dictionary;
      
      protected var var_1341:Dictionary;
      
      protected var var_1082:Dictionary;
      
      protected var var_1620:Dictionary;
      
      protected var var_2142:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1342 = new Dictionary();
         this.var_1341 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1342,this.var_1341);
         this.var_1082 = new Dictionary();
         this.var_1620 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1082,this.var_1620);
         this.var_2142 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1400,const_49);
         return param1.replace(const_1401,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1342)
            {
               delete this.var_1342[_loc1_];
            }
            for(_loc1_ in this.var_1341)
            {
               delete this.var_1341[_loc1_];
            }
            for(_loc1_ in this.var_1082)
            {
               delete this.var_1082[_loc1_];
            }
            for(_loc1_ in this.var_1620)
            {
               delete this.var_1620[_loc1_];
            }
            this.var_2142.dispose();
            this.var_2142 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         {
            _loc8_ = param1.child(const_1013);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1012).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1011);
         ...
         if(param1.localName() == const_1011)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1342[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_451,variables,"")));
         style = uint(this.parseAttribute(xml,const_1395,variables,style));
         params = uint(this.parseAttribute(xml,const_661,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1402,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1398,variables,visible.toString()) == const_662;
         ...
         if(xml.child(const_661).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_451,variables,"") as String;
               if(this.var_1082[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_451)) + "\"!");
               }
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1013)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1406,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1396,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1394,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_662;
         blend = Number(this.parseAttribute(xml,const_1233,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1404,variables,window.clipping.toString()) == const_662;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1403,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1012).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1341[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1197) == -1)
                  {
