package com.sulake.core.window.utils
{
   ...
   public class TextFieldCache implements IDisposable
   {
      ...
      private static var var_1006:Map = new Map();
      ...
      {
         var _loc2_:TextField = var_1006[param1.name];
         if(_loc2_)
         {
            return _loc2_;
         }
         ...
         if(!param1)
         {
            param1 = TextStyleManager.getStyle(TextStyleManager.const_204);
         }
         ...
         _loc3_.underline = param1.textDecoration == TextStyle.const_946 ? true : null;
