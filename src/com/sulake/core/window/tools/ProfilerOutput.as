package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1428:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1427:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_158:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_158 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1428() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_158)
         {
            this.var_158.removeStopEventListener(this.refresh);
            this.var_158 = null;
         }
         if(!this.var_158 && param1)
         {
            this.var_158 = param1;
            this.var_158.addStopEventListener(this.refresh);
         }
      }
      ...
      {
         var _loc2_:Array = this.var_158.getProfilerAgentsInArray();
         ...
         if(this.var_1774)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_158.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_158.numBitmapAssetInstances + " / " + this.var_158.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_158.numTrackedBitmapDataInstances + " / " + this.var_158.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1427() as ByteArray;
