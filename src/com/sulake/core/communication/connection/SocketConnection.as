package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1769:int = 10000;
      ...
      private var var_487:ByteArray;
      
      private var var_1113:IEncryption;
      
      private var var_719:IProtocol;
      
      private var _id:String;
      
      private var var_1112:IMessageClassManager;
      
      private var var_278:ICoreCommunicationManager;
      
      private var var_488:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_278 = param2;
         this.var_487 = new ByteArray();
         this.var_1112 = new MessageClassManager();
         this.var_78 = new Socket();
         this.var_340 = new Timer(const_1769,1);
         this.var_340.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_488)
         {
            this.var_488.connectionInit(param1,param2);
         }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1112.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         var _loc6_:ByteArray = this.var_719.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_488)
         {
            this.var_488.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1113 != null)
         {
            _loc3_ = this.var_1113.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1112.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1113 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_719.getMessages(this.var_487,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_488)
               {
                  this.var_488.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1112.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_487,offset);
               this.var_487 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_487.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_487.writeByte(this.var_78.readUnsignedByte());
         }
      }
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         _loc2_.text = "Socket Timeout (" + this.var_340.delay + " ms). Possible Firewall.";
