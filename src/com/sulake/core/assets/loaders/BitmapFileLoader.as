package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1080 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_43 = new Loader();
         this.var_1085 = new LoaderContext();
         this.var_1085.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1085);
         }
      }
      ...
      {
         this.var_1080 = param1.url;
         var_328 = 0;
         this.var_43.load(param1,this.var_1085);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_328 < var_2921)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1080 + (this.var_1080.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_328),this.var_1085);
               return true;
            }
         }
         return false;
