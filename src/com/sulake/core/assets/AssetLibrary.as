package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_935:String = "AssetLibraryLoaded";
      
      public static const const_1668:String = "AssetLibraryUnloaded";
      
      public static const const_1728:String = "AssetLibraryLoadError";
      
      private static const const_451:String = "name";
      
      private static const const_1064:String = "asset";
      
      private static const const_1065:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1066:String = "library";
      
      private static var var_320:Dictionary;
      
      private static var var_2055:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_556:uint = 0;
      
      private static var var_1046:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_556;
         this.var_466 = new Dictionary(false);
         this.var_555 = new Dictionary(false);
         this.var_1049 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_686 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1066);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1064);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_451);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1065);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_686 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1046.splice(var_1046.indexOf(this),1);
            --var_556;
            this.var_555 = null;
            this.var_1049 = null;
            this.var_171 = null;
      ...
      {
         if(this.var_686 == param1.url && this.var_1048)
         {
            if(!this.var_1047 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_685);
            }
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_555)
         {
            _loc2_ = this.var_555[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_555[_loc1_];
         }
         for(_loc1_ in this.var_171)
         {
            delete this.var_171[_loc1_];
         }
         for(_loc1_ in this.var_1049)
         {
            delete this.var_1049[_loc1_];
         }
         if(this.var_43 != null)
         {
            this.var_43.dispose();
         ...
         this.var_1048 = false;
         this.var_686 = null;
         dispatchEvent(new Event(AssetLibrary.const_1668));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1049[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_555[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_47,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1266,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1180,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1287,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1280,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_555[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_555[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_467;
                     this.var_468.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_555[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_468.length ? this.getAssetByName(this.var_468[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_171)
         {
            ...
            {
               return this.var_468.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_171[param1] != null || (this.var_685 != null ? this.var_685[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_2055.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_171)
            {
               if(this.var_171[_loc2_] == param1)
               {
                  this.var_468.splice(this.var_468.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_466.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_466[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_466[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_466)
         {
            _loc3_ = AssetTypeDeclaration(this.var_466[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_466)
         {
            _loc4_ = AssetTypeDeclaration(this.var_466[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_685 = _loc2_.resource;
         this.var_686 = _loc2_.url;
         if(this.var_1047)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_685);
         }
         this.var_1048 = true;
         dispatchEvent(new Event(AssetLibrary.const_935));
         dispatchEvent(new Event(AssetLibrary.const_1203));
         if(this.var_1047)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1728));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1066);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1064);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_451).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_686 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_685[param1]);
                  _loc6_ = _loc3_.child(const_1065);
                  if(_loc6_.length())
                  {
