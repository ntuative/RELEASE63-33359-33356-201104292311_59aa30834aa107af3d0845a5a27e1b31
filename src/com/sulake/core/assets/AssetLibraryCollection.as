package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1085:LoaderContext;
      
      protected var var_475:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1085 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_475 = new AssetLibrary("lib-" + this.var_579++);
         this.var_29.push(this.var_475);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1085;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_579++);
      ...
      {
         return this.var_475.loadFromResource(param1,param2);
      }
      ...
      {
         return this.var_475.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_475.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_475.createAsset(param1,param2);
      }
      ...
      {
         return this.var_475.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_475.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_475.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_29.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_475.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_29.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
