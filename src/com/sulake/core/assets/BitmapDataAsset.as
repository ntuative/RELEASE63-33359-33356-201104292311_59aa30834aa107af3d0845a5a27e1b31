package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      private var var_1883:AssetTypeDeclaration;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_105 is BitmapDataAsset)
         {
            ...
            this.var_1558 = BitmapDataAsset(this.var_105).var_1558;
            this.var_1557 = BitmapDataAsset(this.var_105).var_1557;
            if(this._bitmap != null)
            {
               this.var_105 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1558 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
